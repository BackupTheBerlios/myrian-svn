...
public class DataSuite extends PackageTestSuite {
    ...
    public final static String versionId = "$Id: //eng/persistence/dev/cap/test/src/com/arsdigita/persistence/tests/data/DataSuite.java#1 $ by $Author: rhs $, $DateTime: 2004/06/07 13:49:55 $";
