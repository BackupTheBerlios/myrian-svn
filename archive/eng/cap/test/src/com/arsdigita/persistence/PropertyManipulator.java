...
public class PropertyManipulator {
    ...
    public final static String versionId = "$Id: //eng/persistence/dev/cap/test/src/com/arsdigita/persistence/PropertyManipulator.java#2 $ by $Author: dennis $, $DateTime: 2004/08/30 14:24:55 $";
