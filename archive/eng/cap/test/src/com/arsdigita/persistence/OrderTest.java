...
public abstract class OrderTest extends PersistenceTestCase {
    ...
    public final static String versionId = "$Id: //eng/persistence/dev/cap/test/src/com/arsdigita/persistence/OrderTest.java#2 $ by $Author: dennis $, $DateTime: 2004/08/30 14:24:55 $";
