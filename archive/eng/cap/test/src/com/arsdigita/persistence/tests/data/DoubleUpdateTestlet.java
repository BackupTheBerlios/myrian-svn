...
public class DoubleUpdateTestlet extends Testlet {
    ...
    public final static String versionId = "$Id: //eng/persistence/dev/cap/test/src/com/arsdigita/persistence/tests/data/DoubleUpdateTestlet.java#3 $ by $Author: dennis $, $DateTime: 2004/09/01 11:40:07 $";
