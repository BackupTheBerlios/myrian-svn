...
public class KeyGenerator {
    ...
    public static final String versionId = "$Id: //eng/persistence/dev/cap/test/src/com/arsdigita/persistence/KeyGenerator.java#2 $ by $Author: dennis $, $DateTime: 2004/08/30 14:24:55 $";
