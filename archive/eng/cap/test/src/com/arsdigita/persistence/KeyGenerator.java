...
public class KeyGenerator {
    ...
    public static final String versionId = "$Id: //eng/persistence/dev/cap/test/src/com/arsdigita/persistence/KeyGenerator.java#1 $ by $Author: rhs $, $DateTime: 2004/06/07 13:49:55 $";
