...
public class DatatypeTest extends PersistenceTestCase {
    ...
    public final static String versionId = "$Id: //eng/persistence/dev/cap/test/src/com/arsdigita/persistence/DatatypeTest.java#1 $ by $Author: rhs $, $DateTime: 2004/06/07 13:49:55 $";
