...
public abstract class Testlet {
    ...
    public final static String versionId = "$Id: //eng/persistence/dev/cap/test/src/com/arsdigita/persistence/tests/data/Testlet.java#3 $ by $Author: dennis $, $DateTime: 2004/09/01 11:40:07 $";
