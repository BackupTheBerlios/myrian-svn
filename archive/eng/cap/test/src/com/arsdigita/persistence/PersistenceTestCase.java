...
public class PersistenceTestCase extends TestCase {
    ...
    public final static String versionId = "$Id: //eng/persistence/dev/cap/test/src/com/arsdigita/persistence/PersistenceTestCase.java#3 $ by $Author: dennis $, $DateTime: 2004/08/30 14:24:55 $";
