...
public class BooleanSwitch extends Switch {
    ...
    public final static String versionId = "$Id: //eng/persistence/dev/cap/src/com/arsdigita/util/cmd/BooleanSwitch.java#3 $ by $Author: dennis $, $DateTime: 2004/09/01 11:40:07 $";
