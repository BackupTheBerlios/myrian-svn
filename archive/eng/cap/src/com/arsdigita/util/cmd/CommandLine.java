...
public class CommandLine {
    ...
    public final static String versionId = "$Id: //eng/persistence/dev/cap/src/com/arsdigita/util/cmd/CommandLine.java#1 $ by $Author: rhs $, $DateTime: 2004/06/07 13:49:55 $";
