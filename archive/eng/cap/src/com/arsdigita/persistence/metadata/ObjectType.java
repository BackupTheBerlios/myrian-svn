...
public class ObjectType extends CompoundType {
    ...
    public final static String versionId = "$Id: //eng/persistence/dev/cap/src/com/arsdigita/persistence/metadata/ObjectType.java#2 $ by $Author: dennis $, $DateTime: 2004/08/30 14:24:55 $";
