...
class ZipSource implements PDLSource {
    ...
    public final static String versionId = "$Id: //eng/persistence/dev/cap/src/com/arsdigita/persistence/pdl/ZipSource.java#1 $ by $Author: rhs $, $DateTime: 2004/06/07 13:49:55 $";
