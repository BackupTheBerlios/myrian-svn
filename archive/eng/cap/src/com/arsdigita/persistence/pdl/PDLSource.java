...
public interface PDLSource {
    ...
    public final static String versionId = "$Id: //eng/persistence/dev/cap/src/com/arsdigita/persistence/pdl/PDLSource.java#3 $ by $Author: dennis $, $DateTime: 2004/09/01 11:40:07 $";
