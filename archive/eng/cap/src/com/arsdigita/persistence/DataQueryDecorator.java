 ...
 * @version $Id: //eng/persistence/dev/cap/src/com/arsdigita/persistence/DataQueryDecorator.java#2 $
 */
public class DataQueryDecorator implements DataQuery {

    String versionId = "$Id: //eng/persistence/dev/cap/src/com/arsdigita/persistence/DataQueryDecorator.java#2 $ by $Author: dennis $, $DateTime: 2004/08/30 14:24:55 $";
