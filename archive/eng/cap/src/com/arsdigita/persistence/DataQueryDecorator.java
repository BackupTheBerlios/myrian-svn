 ...
 * @version $Id: //eng/persistence/dev/cap/src/com/arsdigita/persistence/DataQueryDecorator.java#1 $
 */
public class DataQueryDecorator implements DataQuery {

    String versionId = "$Id: //eng/persistence/dev/cap/src/com/arsdigita/persistence/DataQueryDecorator.java#1 $ by $Author: rhs $, $DateTime: 2004/06/07 13:49:55 $";
