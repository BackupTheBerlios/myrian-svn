...
public class PooledConnectionSource implements ConnectionSource {
    ...
    public final static String versionId = "$Id: //eng/persistence/dev/cap/src/com/arsdigita/persistence/PooledConnectionSource.java#2 $ by $Author: dennis $, $DateTime: 2004/08/30 14:24:55 $";
