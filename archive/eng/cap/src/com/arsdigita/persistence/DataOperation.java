 ...
 * @since 4.5
 * @version $Id: //eng/persistence/dev/cap/src/com/arsdigita/persistence/DataOperation.java#1 $
 */
public class DataOperation {

    public static final String versionId = "$Id: //eng/persistence/dev/cap/src/com/arsdigita/persistence/DataOperation.java#1 $ by $Author: rhs $, $DateTime: 2004/06/07 13:49:55 $";
