...
public class SessionManager {
    ...
    public static final String versionId = "$Id: //eng/persistence/dev/cap/src/com/arsdigita/persistence/SessionManager.java#1 $ by $Author: rhs $, $DateTime: 2004/06/07 13:49:55 $";
