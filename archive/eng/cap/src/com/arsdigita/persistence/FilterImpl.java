...
abstract class FilterImpl implements Filter {
    ...
    public final static String versionId = "$Id: //eng/persistence/dev/cap/src/com/arsdigita/persistence/FilterImpl.java#2 $ by $Author: dennis $, $DateTime: 2004/08/30 14:24:55 $";
