...
public class TestRunner {
    ...
    public final static String versionId = "$Id: //eng/persistence/dev/test/src/org/myrian/persistence/TestRunner.java#1 $ by $Author: vadim $, $DateTime: 2004/10/01 18:41:18 $";
