...
public abstract class SQLLoader {
    ...
    public final static String versionId = "$Id: //eng/persistence/dev/test/src/com/arsdigita/installer/SQLLoader.java#1 $ by $Author: rhs $, $DateTime: 2004/06/07 13:49:55 $";
