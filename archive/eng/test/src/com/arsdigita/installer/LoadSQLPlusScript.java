...
public class LoadSQLPlusScript {
    ...
    public static final String versionId = "$Id: //eng/persistence/dev/test/src/com/arsdigita/installer/LoadSQLPlusScript.java#1 $ by $Author: rhs $, $DateTime: 2004/06/07 13:49:55 $";
