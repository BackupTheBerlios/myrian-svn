...
public class QueryTest extends TestCase {
    ...
    public final static String versionId = "$Id: //eng/persistence/dev/test/src/com/redhat/persistence/oql/QueryTest.java#1 $ by $Author: rhs $, $DateTime: 2004/06/07 13:49:55 $";
