...
public class QueryTest extends TestCase {
    ...
    public final static String versionId = "$Id: //eng/persistence/dev/test/src/com/redhat/persistence/oql/QueryTest.java#6 $ by $Author: dennis $, $DateTime: 2004/09/01 11:40:07 $";
