...
class MultiSet {
    ...
    public final static String versionId = "$Id: //eng/persistence/dev/test/src/com/redhat/persistence/oql/MultiSet.java#3 $ by $Author: dennis $, $DateTime: 2004/09/01 11:40:07 $";
