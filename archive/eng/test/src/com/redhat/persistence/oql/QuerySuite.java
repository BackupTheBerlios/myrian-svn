...
public class QuerySuite extends TestSuite {
    ...
    public final static String versionId = "$Id: //eng/persistence/dev/test/src/com/redhat/persistence/oql/QuerySuite.java#5 $ by $Author: dennis $, $DateTime: 2004/08/30 14:24:55 $";
