...
public class ProtoTest extends TestCase {
    ...
    public final static String versionId = "$Id: //eng/persistence/dev/test/src/com/redhat/persistence/ProtoTest.java#1 $ by $Author: rhs $, $DateTime: 2004/06/07 13:49:55 $";
