...
public class PDL {
    ...
    public final static String versionId = "$Id: //eng/persistence/dev/src/org/myrian/persistence/pdl/PDL.java#1 $ by $Author: vadim $, $DateTime: 2004/10/01 18:41:18 $";
    ...
    private void emitGlobal(Root root) {
        ...
        glob.loadResource("org/myrian/persistence/pdl/global.pdl");
        glob.emit(root);
    }
    ...
    */
    ...
    private SQLBlock getBlock(ObjectMap om, SQLBlockNd nd) {
        ...
        try {
            ...
            return block;
        } catch (org.myrian.persistence.common.ParseException e) {
            m_errors.fatal(nd, e.getMessage());
            return null;
        }
    }
