...
public class DeleteEvent extends ObjectEvent {
    ...
    public final static String versionId = "$Id: //eng/persistence/dev/src/org/myrian/persistence/DeleteEvent.java#1 $ by $Author: vadim $, $DateTime: 2004/10/01 18:41:18 $";
