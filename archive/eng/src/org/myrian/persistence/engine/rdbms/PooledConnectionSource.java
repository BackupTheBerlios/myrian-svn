...
public final class PooledConnectionSource implements ConnectionSource {
    ...
    public final static String versionId = "$Id: //eng/persistence/dev/src/org/myrian/persistence/engine/rdbms/PooledConnectionSource.java#1 $ by $Author: vadim $, $DateTime: 2004/10/01 18:41:18 $";
    ...
    public synchronized void release(Connection conn) {
        if (!m_connections.contains(conn)) {
            throw new IllegalArgumentException
                ("connection did not come from this source: " + conn);
        }
