...
public class Alias extends Property {
    ...
    public final static String versionId = "$Id: //eng/persistence/dev/src/com/redhat/persistence/metadata/Alias.java#1 $ by $Author: rhs $, $DateTime: 2004/06/07 13:49:55 $";
