...
public class Column extends Element {
    ...
    public final static String versionId = "$Id: //eng/persistence/dev/src/com/redhat/persistence/metadata/Column.java#3 $ by $Author: dennis $, $DateTime: 2004/08/30 14:24:55 $";
