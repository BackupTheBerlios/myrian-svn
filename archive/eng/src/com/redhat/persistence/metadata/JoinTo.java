...
public class JoinTo extends Mapping {
    ...
    public final static String versionId = "$Id: //eng/persistence/dev/src/com/redhat/persistence/metadata/JoinTo.java#2 $ by $Author: rhs $, $DateTime: 2004/08/05 12:04:47 $";
