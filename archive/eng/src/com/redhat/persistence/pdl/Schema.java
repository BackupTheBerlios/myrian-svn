...
public class Schema {
    ...
    public final static String versionId = "$Id: //eng/persistence/dev/src/com/redhat/persistence/pdl/Schema.java#4 $ by $Author: dennis $, $DateTime: 2004/09/07 10:26:15 $";
