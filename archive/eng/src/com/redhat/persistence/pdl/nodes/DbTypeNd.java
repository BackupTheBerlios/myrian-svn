...
public class DbTypeNd extends Node {
    ...
    public final static String versionId = "$Id: //eng/persistence/dev/src/com/redhat/persistence/pdl/nodes/DbTypeNd.java#4 $ by $Author: vadim $, $DateTime: 2004/10/01 15:45:16 $";
