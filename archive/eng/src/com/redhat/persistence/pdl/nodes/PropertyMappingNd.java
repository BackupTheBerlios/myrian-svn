...
public class PropertyMappingNd extends Node {
    ...
    public final static String versionId = "$Id: //eng/persistence/dev/src/com/redhat/persistence/pdl/nodes/PropertyMappingNd.java#1 $ by $Author: rhs $, $DateTime: 2004/09/13 16:23:12 $";
