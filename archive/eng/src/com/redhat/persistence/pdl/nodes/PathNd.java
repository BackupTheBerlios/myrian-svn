...
public class PathNd extends Node {
    ...
    public final static String versionId = "$Id: //eng/persistence/dev/src/com/redhat/persistence/pdl/nodes/PathNd.java#2 $ by $Author: dennis $, $DateTime: 2004/08/30 14:24:55 $";
