...
public class ModelNd extends Node {
    ...
    public final static String versionId = "$Id: //eng/persistence/dev/src/com/redhat/persistence/pdl/nodes/ModelNd.java#3 $ by $Author: dennis $, $DateTime: 2004/09/07 10:26:15 $";
