...
abstract class SimpleAdapter extends Adapter {
    ...
    public final static String versionId = "$Id: //eng/persistence/dev/src/com/redhat/persistence/pdl/adapters/SimpleAdapter.java#1 $ by $Author: rhs $, $DateTime: 2004/06/07 13:49:55 $";
