...
public class BigIntegerAd extends SimpleAdapter {
    ...
    public final static String versionId = "$Id: //eng/persistence/dev/src/com/redhat/persistence/pdl/adapters/BigIntegerAd.java#2 $ by $Author: dennis $, $DateTime: 2004/08/30 14:24:55 $";
