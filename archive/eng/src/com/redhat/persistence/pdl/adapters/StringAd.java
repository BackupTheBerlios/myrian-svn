...
public class StringAd extends SimpleAdapter {
    ...
    public final static String versionId = "$Id: //eng/persistence/dev/src/com/redhat/persistence/pdl/adapters/StringAd.java#5 $ by $Author: dennis $, $DateTime: 2004/09/07 10:26:15 $";
