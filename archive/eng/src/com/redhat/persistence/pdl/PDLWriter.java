...
public class PDLWriter {
    ...
    public final static String versionId = "$Id: //eng/persistence/dev/src/com/redhat/persistence/pdl/PDLWriter.java#4 $ by $Author: dennis $, $DateTime: 2004/08/30 14:24:55 $";
