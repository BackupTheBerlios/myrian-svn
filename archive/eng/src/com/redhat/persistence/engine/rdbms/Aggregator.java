...
class Aggregator extends Event.Switch {
    ...
    public final static String versionId = "$Id: //eng/persistence/dev/src/com/redhat/persistence/engine/rdbms/Aggregator.java#5 $ by $Author: dennis $, $DateTime: 2004/08/30 14:24:55 $";
