...
class ResultCycle {
    ...
    public final static String versionId = "$Id: //eng/persistence/dev/src/com/redhat/persistence/engine/rdbms/ResultCycle.java#4 $ by $Author: vadim $, $DateTime: 2004/10/01 15:45:16 $";
