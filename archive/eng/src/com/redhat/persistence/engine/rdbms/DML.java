...
abstract class DML extends Operation {
    ...
    public final static String versionId = "$Id: //eng/persistence/dev/src/com/redhat/persistence/engine/rdbms/DML.java#1 $ by $Author: rhs $, $DateTime: 2004/06/07 13:49:55 $";
