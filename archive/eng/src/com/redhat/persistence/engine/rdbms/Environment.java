...
class Environment {
    ...
    public final static String versionId = "$Id: //eng/persistence/dev/src/com/redhat/persistence/engine/rdbms/Environment.java#3 $ by $Author: dennis $, $DateTime: 2004/08/30 14:24:55 $";
