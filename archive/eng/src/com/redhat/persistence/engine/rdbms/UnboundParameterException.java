...
public class UnboundParameterException extends RDBMSException {
    ...
    public final static String versionId = "$Id: //eng/persistence/dev/src/com/redhat/persistence/engine/rdbms/UnboundParameterException.java#1 $ by $Author: rhs $, $DateTime: 2004/06/07 13:49:55 $";
