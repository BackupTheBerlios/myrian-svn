...
public class Equals extends BinaryCondition {
    ...
    public final static String versionId = "$Id: //eng/persistence/dev/src/com/redhat/persistence/oql/Equals.java#5 $ by $Author: dennis $, $DateTime: 2004/09/07 10:26:15 $";
