...
public class Exists extends UnaryCondition {
    ...
    public final static String versionId = "$Id: //eng/persistence/dev/src/com/redhat/persistence/oql/Exists.java#3 $ by $Author: dennis $, $DateTime: 2004/09/07 10:26:15 $";
