...
public class Static extends Expression {
    ...
    public final static String versionId = "$Id: //eng/persistence/dev/src/com/redhat/persistence/oql/Static.java#5 $ by $Author: dennis $, $DateTime: 2004/09/07 10:26:15 $";
