...
public abstract class AbstractJoin extends Expression {
    ...
    public final static String versionId = "$Id: //eng/persistence/dev/src/com/redhat/persistence/oql/AbstractJoin.java#6 $ by $Author: dennis $, $DateTime: 2004/09/07 10:26:15 $";
