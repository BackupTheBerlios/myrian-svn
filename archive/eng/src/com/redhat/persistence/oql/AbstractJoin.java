...
public abstract class AbstractJoin extends Expression {
    ...
    public final static String versionId = "$Id: //eng/persistence/dev/src/com/redhat/persistence/oql/AbstractJoin.java#5 $ by $Author: dennis $, $DateTime: 2004/08/30 14:24:55 $";
