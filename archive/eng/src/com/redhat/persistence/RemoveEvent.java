...
public class RemoveEvent extends PropertyEvent {
    ...
    public final static String versionId = "$Id: //eng/persistence/dev/src/com/redhat/persistence/RemoveEvent.java#2 $ by $Author: dennis $, $DateTime: 2004/08/30 14:24:55 $";
