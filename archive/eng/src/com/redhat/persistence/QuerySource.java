...
public class QuerySource {
    ...
    public final static String versionId = "$Id: //eng/persistence/dev/src/com/redhat/persistence/QuerySource.java#3 $ by $Author: dennis $, $DateTime: 2004/09/07 10:26:15 $";
