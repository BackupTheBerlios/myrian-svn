 ...
 * SQLDebugger.startNewFile("txns", conn);
 *
 ...
 * @since 2003/02/06
 * @version $Revision: #1 $ $Date: 2004/07/26 $
 **/
public final class SQLDebugger {
     ...
     **/
    public static void startNewFile(String prefix, Connection conn) {
     ...
     * #startNewFile(String, Connection)}.  If you forget to call this method or if the
    ...
    public static void dumpQuery(String debugMsg,
        ...
        try {
            Connection conn = debugger().getConnection();
