 ...
 *
 * @author David Eison
 * @version $Id: //eng/persistence/dev/src/com/arsdigita/util/UncheckedWrapperException.java#3 $
 */
public class UncheckedWrapperException extends RuntimeException {

    public static final String versionId = "$Id: //eng/persistence/dev/src/com/arsdigita/util/UncheckedWrapperException.java#3 $";
