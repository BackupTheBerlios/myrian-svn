 ...
 *
 * @since   2004-01-19
 * @version $Id: //eng/persistence/dev/src/com/arsdigita/util/WrappedError.java#3 $
 */
public class WrappedError extends Error {

    public static final String versionId = "$Id: //eng/persistence/dev/src/com/arsdigita/util/WrappedError.java#3 $";
