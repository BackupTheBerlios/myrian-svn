...
public class ProtoSuite extends PackageTestSuite {
    ...
    public final static String versionId = "$Id: //core-platform/proto/test/src/com/redhat/persistence/ProtoSuite.java#1 $ by $Author: dennis $, $DateTime: 2003/08/04 15:56:00 $";
