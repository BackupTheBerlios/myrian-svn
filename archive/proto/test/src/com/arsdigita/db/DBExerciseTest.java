...
public class DBExerciseTest extends TestCase {
    ...
    public static final String versionId = "$Id: //core-platform/proto/test/src/com/arsdigita/db/DBExerciseTest.java#4 $ by $Author: dennis $, $DateTime: 2003/08/04 16:15:53 $";
