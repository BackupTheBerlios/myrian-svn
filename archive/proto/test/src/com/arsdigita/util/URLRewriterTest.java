...
public class URLRewriterTest extends TestCase {
    ...
    public static final String versionId = "$Id: //core-platform/proto/test/src/com/arsdigita/util/URLRewriterTest.java#1 $ by $Author: dennis $, $DateTime: 2002/11/27 19:51:05 $";
