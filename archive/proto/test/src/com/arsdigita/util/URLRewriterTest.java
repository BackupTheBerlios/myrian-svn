...
public class URLRewriterTest extends TestCase {
    ...
    public static final String versionId = "$Id: //core-platform/proto/test/src/com/arsdigita/util/URLRewriterTest.java#3 $ by $Author: dennis $, $DateTime: 2003/08/04 16:15:53 $";
