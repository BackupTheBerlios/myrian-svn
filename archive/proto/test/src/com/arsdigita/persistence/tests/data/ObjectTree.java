...
public class ObjectTree {
    ...
    public final static String versionId = "$Id: //core-platform/proto/test/src/com/arsdigita/persistence/tests/data/ObjectTree.java#4 $ by $Author: dennis $, $DateTime: 2003/08/04 16:15:53 $";
