...
public class DataSource {
    ...
    public final static String versionId = "$Id: //core-platform/proto/test/src/com/arsdigita/persistence/tests/data/DataSource.java#1 $ by $Author: dennis $, $DateTime: 2002/11/27 19:51:05 $";
