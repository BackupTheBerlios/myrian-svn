...
public class DataSource {
    ...
    public final static String versionId = "$Id: //core-platform/proto/test/src/com/arsdigita/persistence/tests/data/DataSource.java#5 $ by $Author: dennis $, $DateTime: 2003/08/04 15:56:00 $";
