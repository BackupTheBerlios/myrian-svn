...
public class PropertyIsolationTestlet extends Testlet {
    ...
    public final static String versionId = "$Id: //core-platform/proto/test/src/com/arsdigita/persistence/tests/data/PropertyIsolationTestlet.java#3 $ by $Author: dennis $, $DateTime: 2003/08/04 16:15:53 $";
