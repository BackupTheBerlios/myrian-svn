...
public class PropertyIsolationTestlet extends Testlet {
    ...
    public final static String versionId = "$Id: //core-platform/proto/test/src/com/arsdigita/persistence/tests/data/PropertyIsolationTestlet.java#1 $ by $Author: ashah $, $DateTime: 2003/05/08 16:23:18 $";
