...
public abstract class Testlet {
    ...
    public final static String versionId = "$Id: //core-platform/proto/test/src/com/arsdigita/persistence/tests/data/Testlet.java#2 $ by $Author: rhs $, $DateTime: 2003/04/09 16:35:55 $";
