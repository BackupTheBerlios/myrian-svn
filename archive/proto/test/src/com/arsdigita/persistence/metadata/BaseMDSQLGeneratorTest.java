...
public class BaseMDSQLGeneratorTest extends PersistenceTestCase {
    ...
    public final static String versionId = "$Id: //core-platform/proto/test/src/com/arsdigita/persistence/metadata/BaseMDSQLGeneratorTest.java#1 $ by $Author: dennis $, $DateTime: 2002/11/27 19:51:05 $";
    ...
    private void addProperty(ObjectType type,
        ...
        Column column = getColumn(getTable(tableName),
