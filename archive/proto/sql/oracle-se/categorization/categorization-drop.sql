...
--
-- $Id: //core-platform/proto/sql/oracle-se/categorization/categorization-drop.sql#1 $
...
-- @cvs-id $Id: //core-platform/proto/sql/oracle-se/categorization/categorization-drop.sql#1 $
--
