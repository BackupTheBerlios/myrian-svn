...
--
-- $Id: //core-platform/proto/sql/oracle-se/categorization/categorization-drop.sql#3 $
...
-- @cvs-id $Id: //core-platform/proto/sql/oracle-se/categorization/categorization-drop.sql#3 $
--
