...
--
-- $Id: //core-platform/proto/sql/default/x/versioning/comment-vcx_operations.sql#1 $
-- $DateTime: 2003/04/09 16:35:55 $

comment on table vcx_operations is '
  An operation is a single modification made to an attribute of
  an object by the user. Transactions are sets of operations.
';
comment on column vcx_operations.classname is '
