 ...
 *
 * @author David Eison
 * @version $Id: //core-platform/proto/src/com/arsdigita/util/UncheckedWrapperException.java#4 $
 */
public class UncheckedWrapperException extends RuntimeException {

    public static final String versionId = "$Id: //core-platform/proto/src/com/arsdigita/util/UncheckedWrapperException.java#4 $";
