 ...
 *
 * @author David Eison 
 * @version $Id: //core-platform/proto/src/com/arsdigita/util/CheckedWrapperException.java#4 $
 */
public class CheckedWrapperException extends Exception {

    public static final String versionId = "$Id: //core-platform/proto/src/com/arsdigita/util/CheckedWrapperException.java#4 $";
