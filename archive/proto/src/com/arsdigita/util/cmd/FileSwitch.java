...
public class FileSwitch extends Switch {
    ...
    public final static String versionId = "$Id: //core-platform/proto/src/com/arsdigita/util/cmd/FileSwitch.java#4 $ by $Author: dennis $, $DateTime: 2003/08/04 16:15:53 $";
