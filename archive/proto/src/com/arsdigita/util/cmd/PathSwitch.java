...
public class PathSwitch extends Switch {
    ...
    public final static String versionId = "$Id: //core-platform/proto/src/com/arsdigita/util/cmd/PathSwitch.java#1 $ by $Author: dennis $, $DateTime: 2002/11/27 19:51:05 $";
