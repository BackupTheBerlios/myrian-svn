 ...
 * @version $Id: //core-platform/proto/src/com/arsdigita/util/Assert.java#4 $
 */
public class Assert {
    public static final String versionId =
        "$Id: //core-platform/proto/src/com/arsdigita/util/Assert.java#4 $" +
        "$Author: vadim $" +
        "$DateTime: 2003/04/16 16:35:39 $";
