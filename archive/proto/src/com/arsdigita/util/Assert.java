 ...
 * @version $Id: //core-platform/proto/src/com/arsdigita/util/Assert.java#6 $
 */
public class Assert {
    public static final String versionId =
        "$Id: //core-platform/proto/src/com/arsdigita/util/Assert.java#6 $" +
        "$Author: ashah $" +
        "$DateTime: 2003/05/12 16:04:41 $";
