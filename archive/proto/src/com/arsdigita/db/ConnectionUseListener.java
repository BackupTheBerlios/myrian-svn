...
public interface ConnectionUseListener {
    ...
    public static final String versionId = "$Id: //core-platform/proto/src/com/arsdigita/db/ConnectionUseListener.java#1 $ by $Author: dennis $, $DateTime: 2002/11/27 19:51:05 $";
