 ...
 *
 * @author David Eison
 * @version $Id: //core-platform/proto/src/com/arsdigita/db/ResultSetEvent.java#4 $
 * @since 4.6
 */
public class ResultSetEvent extends java.util.EventObject {

    public static final String versionId = "$Id: //core-platform/proto/src/com/arsdigita/db/ResultSetEvent.java#4 $ by $Author: dennis $, $DateTime: 2003/08/04 16:15:53 $";
