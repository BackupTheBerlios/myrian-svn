 ...
 *
 * @author David Dao
 * @version $Id: //core-platform/proto/src/com/arsdigita/db/oracle/OracleConnectionPoolImpl.java#4 $ $DateTime: 2003/08/04 16:15:53 $
 * @since
 *
 */
...
public class OracleConnectionPoolImpl extends BaseConnectionPool {
    ...
    public static final String versionId = "$Author: dennis $ " +
        "- $Date: 2003/08/04 $ " + 
        "$Id: //core-platform/proto/src/com/arsdigita/db/oracle/OracleConnectionPoolImpl.java#4 $";
