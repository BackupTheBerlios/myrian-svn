...
public class GenericDataObject implements DataObject {
    ...
    public static final String versionId = "$Id: //core-platform/proto/src/com/arsdigita/persistence/GenericDataObject.java#1 $ by $Author: dennis $, $DateTime: 2002/11/27 19:51:05 $";
    ...
    void setObjectType(ObjectType type) {
        ...
        DataHandler dh = type.getDataHandler();
        if (dh != null) {
            m_dataHandler = dh;
        }
    }
    ...
    public void save() throws PersistenceException {
        ...
        if (m_isDeleted) {
            ...
            doInsert();
            setNew(false);
        } else if (m_data.getFront().size() > 0) {
            doUpdate();
        }
    ...
    public void set(String propertyName, Object value) {
        ...
        fireObserver(new SetEvent(this, propertyName, previous, value), false);
    }
