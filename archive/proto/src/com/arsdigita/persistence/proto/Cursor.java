...
public class Cursor {
    ...
    public final static String versionId = "$Id: //core-platform/proto/src/com/arsdigita/persistence/proto/Cursor.java#5 $ by $Author: rhs $, $DateTime: 2003/01/06 16:31:02 $";
    ...
    protected Cursor(DataSet dset) {
        ...
        m_signature = dset.getBinding().getQuery().getSignature();
    }
    ...
    public boolean next() {
        if (m_rs == null) {
            m_ssn.flush();
            m_rs = m_ssn.getEngine().execute(m_dset.getBinding());
        }
