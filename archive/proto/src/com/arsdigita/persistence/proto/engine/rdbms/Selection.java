...
class Selection {
    ...
    public final static String versionId = "$Id: //core-platform/proto/src/com/arsdigita/persistence/proto/engine/rdbms/Selection.java#1 $ by $Author: rhs $, $DateTime: 2003/01/28 19:17:39 $";
...
/*    public Mapping getMapping() {
    ...
    public String getAlias() {
        if (m_node == getQuery() &&
            m_node.getObjectMap().getKeyProperties().contains(getProperty())) {
