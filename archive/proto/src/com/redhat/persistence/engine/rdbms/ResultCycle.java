...
class ResultCycle {
    ...
    public final static String versionId = "$Id: //core-platform/proto/src/com/redhat/persistence/engine/rdbms/ResultCycle.java#1 $ by $Author: dennis $, $DateTime: 2003/08/04 15:56:00 $";
