...
class StaticOperation extends Operation {
    ...
    public final static String versionId = "$Id: //core-platform/proto/src/com/redhat/persistence/engine/rdbms/StaticOperation.java#2 $ by $Author: dennis $, $DateTime: 2003/08/04 16:15:53 $";
