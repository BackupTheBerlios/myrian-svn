...
class Aggregator extends Event.Switch {
    ...
    public final static String versionId = "$Id: //core-platform/proto/src/com/redhat/persistence/engine/rdbms/Aggregator.java#1 $ by $Author: dennis $, $DateTime: 2003/08/04 15:56:00 $";
