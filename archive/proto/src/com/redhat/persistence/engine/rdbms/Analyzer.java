...
class Analyzer {
    ...
    public final static String versionId = "$Id: //core-platform/proto/src/com/redhat/persistence/engine/rdbms/Analyzer.java#2 $ by $Author: dennis $, $DateTime: 2003/08/04 16:15:53 $";
