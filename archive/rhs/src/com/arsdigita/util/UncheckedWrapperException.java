 ...
 *
 * @author David Eison
 * @version $Id: //users/rhs/persistence/src/com/arsdigita/util/UncheckedWrapperException.java#2 $
 */
public class UncheckedWrapperException extends RuntimeException {

    public static final String versionId = "$Id: //users/rhs/persistence/src/com/arsdigita/util/UncheckedWrapperException.java#2 $";
