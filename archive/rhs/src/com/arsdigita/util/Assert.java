 ...
 * @version $Id: //users/rhs/persistence/src/com/arsdigita/util/Assert.java#1 $
 */
public class Assert {
    public static final String versionId =
        "$Id: //users/rhs/persistence/src/com/arsdigita/util/Assert.java#1 $" +
        "$Author: rhs $" +
        "$DateTime: 2003/11/09 14:41:17 $";
