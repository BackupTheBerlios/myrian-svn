 ...
 * @version $Id: //users/rhs/persistence/src/com/arsdigita/util/Assert.java#2 $
 */
public class Assert {
    public static final String versionId =
        "$Id: //users/rhs/persistence/src/com/arsdigita/util/Assert.java#2 $" +
        "$Author: rhs $" +
        "$DateTime: 2004/04/05 15:33:44 $";
