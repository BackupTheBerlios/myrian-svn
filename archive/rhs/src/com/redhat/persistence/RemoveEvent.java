...
public class RemoveEvent extends PropertyEvent {
    ...
    public final static String versionId = "$Id: //users/rhs/persistence/src/com/redhat/persistence/RemoveEvent.java#1 $ by $Author: rhs $, $DateTime: 2003/11/09 14:41:17 $";
