...
public class JoinPathNd extends StatementNd {
    ...
    public final static String versionId = "$Id: //users/rhs/persistence/src/com/redhat/persistence/pdl/nodes/JoinPathNd.java#2 $ by $Author: rhs $, $DateTime: 2004/04/05 15:33:44 $";
