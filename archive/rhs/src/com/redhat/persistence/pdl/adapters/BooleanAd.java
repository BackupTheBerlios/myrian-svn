...
public class BooleanAd extends SimpleAdapter {
    ...
    public final static String versionId = "$Id: //users/rhs/persistence/src/com/redhat/persistence/pdl/adapters/BooleanAd.java#3 $ by $Author: rhs $, $DateTime: 2004/05/02 13:12:27 $";
