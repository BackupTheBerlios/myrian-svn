...
public class Alias extends Property {
    ...
    public final static String versionId = "$Id: //users/rhs/persistence/src/com/redhat/persistence/metadata/Alias.java#3 $ by $Author: rhs $, $DateTime: 2004/05/02 13:12:27 $";
