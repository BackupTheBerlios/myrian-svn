...
public class UniqueKey extends Constraint {
    ...
    public final static String versionId = "$Id: //users/rhs/persistence/src/com/redhat/persistence/metadata/UniqueKey.java#2 $ by $Author: rhs $, $DateTime: 2004/04/05 15:33:44 $";
