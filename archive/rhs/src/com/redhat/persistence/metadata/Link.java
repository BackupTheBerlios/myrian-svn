...
public class Link extends Property {
    ...
    public final static String versionId = "$Id: //users/rhs/persistence/src/com/redhat/persistence/metadata/Link.java#1 $ by $Author: rhs $, $DateTime: 2003/11/09 14:41:17 $";
