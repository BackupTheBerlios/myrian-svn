...
public abstract class BinaryCondition extends Condition {
    ...
    public final static String versionId = "$Id: //users/rhs/persistence/src/com/redhat/persistence/oql/BinaryCondition.java#1 $ by $Author: rhs $, $DateTime: 2004/04/05 15:33:44 $";
