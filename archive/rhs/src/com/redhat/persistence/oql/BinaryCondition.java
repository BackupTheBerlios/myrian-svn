...
public abstract class BinaryCondition extends Condition {
    ...
    public final static String versionId = "$Id: //users/rhs/persistence/src/com/redhat/persistence/oql/BinaryCondition.java#2 $ by $Author: rhs $, $DateTime: 2004/05/02 13:12:27 $";
