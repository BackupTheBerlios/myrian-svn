...
public abstract class AbstractJoin extends Expression {
    ...
    public final static String versionId = "$Id: //users/rhs/persistence/src/com/redhat/persistence/oql/AbstractJoin.java#2 $ by $Author: rhs $, $DateTime: 2004/05/02 13:12:27 $";
