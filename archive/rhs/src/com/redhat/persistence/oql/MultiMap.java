...
class MultiMap {
    ...
    public final static String versionId = "$Id: //users/rhs/persistence/src/com/redhat/persistence/oql/MultiMap.java#1 $ by $Author: rhs $, $DateTime: 2004/04/05 15:33:44 $";
