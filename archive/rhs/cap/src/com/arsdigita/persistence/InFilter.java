...
class InFilter extends SimpleFilter implements Filter {
    ...
    public final static String versionId = "$Id: //users/rhs/persistence/cap/src/com/arsdigita/persistence/InFilter.java#1 $ by $Author: rhs $, $DateTime: 2004/05/03 11:00:53 $";
