...
public class ObjectType extends CompoundType {
    ...
    public final static String versionId = "$Id: //users/rhs/persistence/cap/src/com/arsdigita/persistence/metadata/ObjectType.java#1 $ by $Author: rhs $, $DateTime: 2004/05/03 11:00:53 $";
