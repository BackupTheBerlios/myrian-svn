 ...
 * @since 4.5
 * @version $Id: //users/rhs/persistence/cap/src/com/arsdigita/persistence/DataOperation.java#1 $
 */
public class DataOperation {

    public static final String versionId = "$Id: //users/rhs/persistence/cap/src/com/arsdigita/persistence/DataOperation.java#1 $ by $Author: rhs $, $DateTime: 2004/05/03 11:00:53 $";
