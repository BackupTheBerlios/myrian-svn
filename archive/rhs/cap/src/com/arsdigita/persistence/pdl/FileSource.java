...
public class FileSource implements PDLSource {
    ...
    public final static String versionId = "$Id: //users/rhs/persistence/cap/src/com/arsdigita/persistence/pdl/FileSource.java#1 $ by $Author: rhs $, $DateTime: 2004/05/03 11:00:53 $";
