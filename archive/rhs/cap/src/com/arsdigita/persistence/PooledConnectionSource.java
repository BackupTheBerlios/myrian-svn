...
public class PooledConnectionSource implements ConnectionSource {
    ...
    public final static String versionId = "$Id: //users/rhs/persistence/cap/src/com/arsdigita/persistence/PooledConnectionSource.java#1 $ by $Author: rhs $, $DateTime: 2004/05/03 11:00:53 $";
