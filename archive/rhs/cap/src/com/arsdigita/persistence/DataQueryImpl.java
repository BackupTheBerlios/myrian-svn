...
class DataQueryImpl implements DataQuery {
    ...
    public final static String versionId = "$Id: //users/rhs/persistence/cap/src/com/arsdigita/persistence/DataQueryImpl.java#1 $ by $Author: rhs $, $DateTime: 2004/05/03 11:00:53 $";
