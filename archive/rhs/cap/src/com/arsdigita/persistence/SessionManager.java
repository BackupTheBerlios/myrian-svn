...
public class SessionManager {
    ...
    public static final String versionId = "$Id: //users/rhs/persistence/cap/src/com/arsdigita/persistence/SessionManager.java#1 $ by $Author: rhs $, $DateTime: 2004/05/03 11:00:53 $";
