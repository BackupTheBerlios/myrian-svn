...
public class CommandLine {
    ...
    public final static String versionId = "$Id: //users/rhs/persistence/cap/src/com/arsdigita/util/cmd/CommandLine.java#1 $ by $Author: rhs $, $DateTime: 2004/05/03 11:00:53 $";
