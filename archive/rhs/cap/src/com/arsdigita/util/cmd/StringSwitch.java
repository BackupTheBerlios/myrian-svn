...
public class StringSwitch extends Switch {
    ...
    public final static String versionId = "$Id: //users/rhs/persistence/cap/src/com/arsdigita/util/cmd/StringSwitch.java#1 $ by $Author: rhs $, $DateTime: 2004/05/03 11:00:53 $";
