 ...
 *
 * @author David Eison 
 * @version $Id: //users/rhs/persistence/cap/test/src/com/arsdigita/util/CheckedWrapperException.java#1 $
 */
public class CheckedWrapperException extends Exception {

    public static final String versionId = "$Id: //users/rhs/persistence/cap/test/src/com/arsdigita/util/CheckedWrapperException.java#1 $";
