...
public class InitializerTest extends TestCase
{
    ...
    public static final String versionId = "$Id: //users/rhs/persistence/cap/test/src/com/arsdigita/persistence/InitializerTest.java#1 $ by $Author: rhs $, $DateTime: 2004/05/03 11:48:01 $";
