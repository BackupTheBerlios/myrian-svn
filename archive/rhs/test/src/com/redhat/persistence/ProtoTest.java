...
public class ProtoTest extends TestCase {
    ...
    public final static String versionId = "$Id: //users/rhs/persistence/test/src/com/redhat/persistence/ProtoTest.java#1 $ by $Author: rhs $, $DateTime: 2004/05/02 13:12:27 $";
