...
public class TestRunner {
    ...
    public final static String versionId = "$Id: //users/rhs/persistence/test/src/com/redhat/persistence/TestRunner.java#1 $ by $Author: rhs $, $DateTime: 2004/05/05 16:10:50 $";
