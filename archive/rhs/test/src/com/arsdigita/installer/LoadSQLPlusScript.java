...
public class LoadSQLPlusScript {
    ...
    public static final String versionId = "$Id: //users/rhs/persistence/test/src/com/arsdigita/installer/LoadSQLPlusScript.java#1 $ by $Author: rhs $, $DateTime: 2004/05/02 13:12:27 $";
