...
class MultiSet {
    ...
    public final static String versionId = "$Id: //core-platform/test-qgen/test/src/com/redhat/persistence/oql/MultiSet.java#1 $ by $Author: rhs $, $DateTime: 2004/02/04 11:20:32 $";
