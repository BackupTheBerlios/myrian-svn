...
final class OrderAssociation {
    ...
    public static final String versionId = "$Id: //core-platform/test-qgen/test/src/com/arsdigita/persistence/OrderAssociation.java#2 $ by $Author: ashah $, $DateTime: 2004/01/29 12:35:08 $";
