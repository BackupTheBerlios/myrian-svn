...
public class InitializerTest extends TestCase
{
    ...
    public static final String versionId = "$Id: //core-platform/test-qgen/test/src/com/arsdigita/persistence/InitializerTest.java#1 $ by $Author: dennis $, $DateTime: 2003/12/10 16:59:20 $";
