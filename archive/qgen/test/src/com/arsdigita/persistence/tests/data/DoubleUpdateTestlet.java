...
public class DoubleUpdateTestlet extends Testlet {
    ...
    public final static String versionId = "$Id: //core-platform/test-qgen/test/src/com/arsdigita/persistence/tests/data/DoubleUpdateTestlet.java#1 $ by $Author: dennis $, $DateTime: 2003/12/10 16:59:20 $";
