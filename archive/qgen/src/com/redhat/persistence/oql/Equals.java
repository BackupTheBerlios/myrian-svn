...
public class Equals extends BinaryCondition {
    ...
    public final static String versionId = "$Id: //core-platform/test-qgen/src/com/redhat/persistence/oql/Equals.java#9 $ by $Author: rhs $, $DateTime: 2004/02/21 18:22:56 $";
