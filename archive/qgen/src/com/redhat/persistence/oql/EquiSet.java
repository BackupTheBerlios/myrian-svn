 ...
 * @version $Revision: #1 $ $Date: 2004/03/08 $
 **/

class EquiSet {

    public final static String versionId = "$Id: //core-platform/test-qgen/src/com/redhat/persistence/oql/EquiSet.java#1 $ by $Author: rhs $, $DateTime: 2004/03/08 23:10:10 $";
