...
public class JoinNd extends Node {
    ...
    public final static String versionId = "$Id: //core-platform/test-qgen/src/com/redhat/persistence/pdl/nodes/JoinNd.java#1 $ by $Author: dennis $, $DateTime: 2003/12/10 16:59:20 $";
