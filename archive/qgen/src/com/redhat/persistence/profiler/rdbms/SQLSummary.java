...
class SQLSummary {
    ...
    public final static String versionId = "$Id: //core-platform/test-qgen/src/com/redhat/persistence/profiler/rdbms/SQLSummary.java#1 $ by $Author: dennis $, $DateTime: 2003/12/10 16:59:20 $";
