...
class Mist implements Collection {
    ...
    public final static String versionId = "$Id: //core-platform/test-qgen/src/com/redhat/persistence/metadata/Mist.java#1 $ by $Author: dennis $, $DateTime: 2003/12/10 16:59:20 $";
