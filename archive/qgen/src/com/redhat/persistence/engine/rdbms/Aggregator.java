...
class Aggregator extends Event.Switch {
    ...
    public final static String versionId = "$Id: //core-platform/test-qgen/src/com/redhat/persistence/engine/rdbms/Aggregator.java#1 $ by $Author: dennis $, $DateTime: 2003/12/10 16:59:20 $";
