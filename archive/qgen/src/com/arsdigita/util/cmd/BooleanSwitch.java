...
public class BooleanSwitch extends Switch {
    ...
    public final static String versionId = "$Id: //core-platform/test-qgen/src/com/arsdigita/util/cmd/BooleanSwitch.java#1 $ by $Author: dennis $, $DateTime: 2003/12/10 16:59:20 $";
