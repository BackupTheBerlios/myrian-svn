 ...
 * @version $Id: //core-platform/test-qgen/src/com/arsdigita/util/servlet/HttpResourceLocator.java#1 $
 */
public class HttpResourceLocator {
    public static final String versionId =
        "$Id: //core-platform/test-qgen/src/com/arsdigita/util/servlet/HttpResourceLocator.java#1 $" +
        "$Author: dennis $" +
