 ...
 * @version $Id: //core-platform/test-qgen/src/com/arsdigita/util/servlet/HttpParameterMap.java#1 $
 */
public class HttpParameterMap {
    public static final String versionId =
        "$Id: //core-platform/test-qgen/src/com/arsdigita/util/servlet/HttpParameterMap.java#1 $" +
        "$Author: dennis $" +
