 ...
 * @version $Id: //core-platform/test-qgen/src/com/arsdigita/util/JavaPropertyReader.java#1 $
 */
public class JavaPropertyReader implements ParameterReader {
    public final static String versionId =
        "$Id: //core-platform/test-qgen/src/com/arsdigita/util/JavaPropertyReader.java#1 $" +
        "$Author: dennis $" +
