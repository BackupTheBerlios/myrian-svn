 ...
 *
 * @since   2004-01-19
 * @version $Id: //core-platform/test-qgen/src/com/arsdigita/util/WrappedError.java#1 $
 */
public class WrappedError extends Error {

    public static final String versionId = "$Id: //core-platform/test-qgen/src/com/arsdigita/util/WrappedError.java#1 $";
