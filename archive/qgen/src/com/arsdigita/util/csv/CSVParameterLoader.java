 ...
 * @version $Id: //core-platform/test-qgen/src/com/arsdigita/util/csv/CSVParameterLoader.java#1 $
 */
public final class CSVParameterLoader implements ParameterLoader {
    public final static String versionId =
        "$Id: //core-platform/test-qgen/src/com/arsdigita/util/csv/CSVParameterLoader.java#1 $" +
        "$Author: dennis $" +
