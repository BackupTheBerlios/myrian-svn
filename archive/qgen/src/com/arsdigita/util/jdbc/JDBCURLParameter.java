 ...
 * @version $Id: //core-platform/test-qgen/src/com/arsdigita/util/jdbc/JDBCURLParameter.java#1 $
 */
public class JDBCURLParameter extends StringParameter {
    public final static String versionId =
        "$Id: //core-platform/test-qgen/src/com/arsdigita/util/jdbc/JDBCURLParameter.java#1 $" +
        "$Author: dennis $" +
