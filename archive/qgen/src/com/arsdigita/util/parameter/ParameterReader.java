 ...
 * @version $Id: //core-platform/test-qgen/src/com/arsdigita/util/parameter/ParameterReader.java#1 $
 */
public interface ParameterReader {
    public final static String versionId =
        "$Id: //core-platform/test-qgen/src/com/arsdigita/util/parameter/ParameterReader.java#1 $" +
        "$Author: dennis $" +
