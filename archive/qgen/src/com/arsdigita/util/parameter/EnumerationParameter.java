 ...
 * @version $Id: //core-platform/test-qgen/src/com/arsdigita/util/parameter/EnumerationParameter.java#1 $
 */
public class EnumerationParameter extends AbstractParameter {
    public final static String versionId =
        "$Id: //core-platform/test-qgen/src/com/arsdigita/util/parameter/EnumerationParameter.java#1 $" +
        "$Author: dennis $" +
