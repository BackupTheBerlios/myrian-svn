 ...
 * @version $Id: //core-platform/test-qgen/src/com/arsdigita/util/parameter/ParameterWriter.java#1 $
 */
public interface ParameterWriter {
    public final static String versionId =
        "$Id: //core-platform/test-qgen/src/com/arsdigita/util/parameter/ParameterWriter.java#1 $" +
        "$Author: dennis $" +
