 ...
 * @version $Id: //core-platform/test-qgen/src/com/arsdigita/util/parameter/ErrorList.java#1 $
 */
public final class ErrorList {
    public final static String versionId =
        "$Id: //core-platform/test-qgen/src/com/arsdigita/util/parameter/ErrorList.java#1 $" +
        "$Author: dennis $" +
