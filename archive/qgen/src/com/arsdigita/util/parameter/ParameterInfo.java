 ...
 * @version $Id: //core-platform/test-qgen/src/com/arsdigita/util/parameter/ParameterInfo.java#1 $
 */
public interface ParameterInfo {
    public final static String versionId =
        "$Id: //core-platform/test-qgen/src/com/arsdigita/util/parameter/ParameterInfo.java#1 $" +
        "$Author: dennis $" +
