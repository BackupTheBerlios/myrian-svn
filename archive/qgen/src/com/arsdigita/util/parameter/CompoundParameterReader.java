 ...
 * @version $Id: //core-platform/test-qgen/src/com/arsdigita/util/parameter/CompoundParameterReader.java#1 $
 */
public class CompoundParameterReader implements ParameterReader {
    public final static String versionId =
        "$Id: //core-platform/test-qgen/src/com/arsdigita/util/parameter/CompoundParameterReader.java#1 $" +
        "$Author: dennis $" +
