 ...
 * @version $Id: //core-platform/test-qgen/src/com/arsdigita/util/parameter/URLParameter.java#1 $
 */
public class URLParameter extends StringParameter {
    public final static String versionId =
        "$Id: //core-platform/test-qgen/src/com/arsdigita/util/parameter/URLParameter.java#1 $" +
        "$Author: dennis $" +
