 ...
 * @version $Id: //core-platform/test-qgen/src/com/arsdigita/util/parameter/Converters.java#1 $
 */
public class Converters {
    public final static String versionId =
        "$Id: //core-platform/test-qgen/src/com/arsdigita/util/parameter/Converters.java#1 $" +
        "$Author: dennis $" +
