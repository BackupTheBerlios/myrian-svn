 ...
 * @version $Id: //core-platform/test-qgen/src/com/arsdigita/util/parameter/MapParameter.java#1 $
 */
public class MapParameter extends AbstractParameter {
    public final static String versionId =
        "$Id: //core-platform/test-qgen/src/com/arsdigita/util/parameter/MapParameter.java#1 $" +
        "$Author: dennis $" +
