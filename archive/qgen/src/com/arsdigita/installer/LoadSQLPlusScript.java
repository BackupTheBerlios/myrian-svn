...
public class LoadSQLPlusScript {
    ...
    public static final String versionId = "$Id: //core-platform/test-qgen/src/com/arsdigita/installer/LoadSQLPlusScript.java#1 $ by $Author: dennis $, $DateTime: 2003/12/10 16:59:20 $";
