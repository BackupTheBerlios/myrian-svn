...
public class HttpServletDummyResponse implements HttpServletResponse {
    ...
    public static final String versionId = "$Id: //core-platform/dev/test/src/com/arsdigita/util/HttpServletDummyResponse.java#7 $ by $Author: dennis $, $DateTime: 2003/08/15 13:46:34 $";
