...
public class DummyRequestContext implements RequestContext {
    ...
    public static final String versionId = "$Id: //core-platform/dev/test/src/com/arsdigita/util/DummyRequestContext.java#6 $ by $Author: dennis $, $DateTime: 2004/08/16 18:10:38 $";
