...
public class URLRewriterTest extends TestCase {
    ...
    public static final String versionId = "$Id: //core-platform/dev/test/src/com/arsdigita/util/URLRewriterTest.java#2 $ by $Author: dennis $, $DateTime: 2002/07/18 13:18:21 $";
