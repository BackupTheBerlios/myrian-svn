...
public class DataObjectManipulator {
    ...
    public final static String versionId = "$Id: //core-platform/dev/test/src/com/arsdigita/persistence/DataObjectManipulator.java#2 $ by $Author: dennis $, $DateTime: 2002/07/18 13:18:21 $";
