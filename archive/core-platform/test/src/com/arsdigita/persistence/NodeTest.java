...
public abstract class NodeTest extends PersistenceTestCase {
    ...
    public final static String versionId = "$Id: //core-platform/dev/test/src/com/arsdigita/persistence/NodeTest.java#7 $ by $Author: dennis $, $DateTime: 2003/08/15 13:46:34 $";
