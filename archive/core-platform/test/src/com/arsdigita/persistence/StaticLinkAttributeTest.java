...
public class StaticLinkAttributeTest extends LinkAttributeTest {
    ...
    public final static String versionId = "$Id: //core-platform/dev/test/src/com/arsdigita/persistence/StaticLinkAttributeTest.java#8 $ by $Author: dennis $, $DateTime: 2004/08/16 18:10:38 $";
