...
public class StaticLinkAttributeTest extends LinkAttributeTest {
    ...
    public final static String versionId = "$Id: //core-platform/dev/test/src/com/arsdigita/persistence/StaticLinkAttributeTest.java#7 $ by $Author: dennis $, $DateTime: 2004/04/07 16:07:11 $";
