...
public class StaticNodeTest extends NodeTest {
    ...
    public final static String versionId = "$Id: //core-platform/dev/test/src/com/arsdigita/persistence/StaticNodeTest.java#8 $ by $Author: dennis $, $DateTime: 2004/08/16 18:10:38 $";
