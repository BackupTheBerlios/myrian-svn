...
public class ExtendLobTest extends PersistenceTestCase {
    ...
    public final static String versionId = "$Id: //core-platform/dev/test/src/com/arsdigita/persistence/ExtendLobTest.java#2 $ by $Author: dennis $, $DateTime: 2003/01/07 14:51:38 $";
