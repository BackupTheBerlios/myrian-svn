...
public class ExtendLobTest extends PersistenceTestCase {
    ...
    public final static String versionId = "$Id: //core-platform/dev/test/src/com/arsdigita/persistence/ExtendLobTest.java#3 $ by $Author: dennis $, $DateTime: 2003/08/15 13:46:34 $";
