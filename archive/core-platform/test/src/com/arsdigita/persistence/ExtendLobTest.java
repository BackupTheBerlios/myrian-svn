...
public class ExtendLobTest extends PersistenceTestCase {
    ...
    public final static String versionId = "$Id: //core-platform/dev/test/src/com/arsdigita/persistence/ExtendLobTest.java#6 $ by $Author: dennis $, $DateTime: 2004/08/16 18:10:38 $";
