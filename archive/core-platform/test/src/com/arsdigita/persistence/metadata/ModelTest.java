...
public class ModelTest extends TestCase
{
    ...
    public final static String versionId = "$Id: //core-platform/dev/test/src/com/arsdigita/persistence/metadata/ModelTest.java#5 $ by $Author: dennis $, $DateTime: 2002/12/11 13:49:53 $";
