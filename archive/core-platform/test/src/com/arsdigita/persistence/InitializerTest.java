...
public class InitializerTest extends TestCase
{
    ...
    public static final String versionId = "$Id: //core-platform/dev/test/src/com/arsdigita/persistence/InitializerTest.java#1 $ by $Author: dennis $, $DateTime: 2002/05/12 18:23:13 $";
