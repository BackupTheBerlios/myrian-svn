...
public class PDLTest extends TestCase {
    ...
    public final static String versionId = "$Id: //core-platform/dev/test/src/com/arsdigita/persistence/pdl/PDLTest.java#2 $ by $Author: rhs $, $DateTime: 2002/05/30 15:13:40 $";
