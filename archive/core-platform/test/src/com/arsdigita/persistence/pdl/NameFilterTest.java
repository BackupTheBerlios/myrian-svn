...
public class NameFilterTest extends TestCase {
    ...
    public final static String versionId = "$Id: //core-platform/dev/test/src/com/arsdigita/persistence/pdl/NameFilterTest.java#2 $ by $Author: dennis $, $DateTime: 2004/03/30 17:47:27 $";
