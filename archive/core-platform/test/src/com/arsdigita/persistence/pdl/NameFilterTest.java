...
public class NameFilterTest extends TestCase {
    ...
    public final static String versionId = "$Id: //core-platform/dev/test/src/com/arsdigita/persistence/pdl/NameFilterTest.java#4 $ by $Author: dennis $, $DateTime: 2004/08/16 18:10:38 $";
