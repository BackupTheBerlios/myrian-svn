...
public class NameFilterTest extends TestCase {
    ...
    public final static String versionId = "$Id: //core-platform/dev/test/src/com/arsdigita/persistence/pdl/NameFilterTest.java#1 $ by $Author: ashah $, $DateTime: 2004/01/16 13:01:04 $";
