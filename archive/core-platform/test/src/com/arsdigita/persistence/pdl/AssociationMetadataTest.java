...
public class AssociationMetadataTest extends TestCase {
    ...
    public final static String versionId = "$Id: //core-platform/dev/test/src/com/arsdigita/persistence/pdl/AssociationMetadataTest.java#2 $ by $Author: justin $, $DateTime: 2003/10/23 15:28:18 $";
