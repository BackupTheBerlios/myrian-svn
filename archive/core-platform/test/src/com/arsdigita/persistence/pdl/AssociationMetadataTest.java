...
public class AssociationMetadataTest extends TestCase {
    ...
    public final static String versionId = "$Id: //core-platform/dev/test/src/com/arsdigita/persistence/pdl/AssociationMetadataTest.java#3 $ by $Author: dennis $, $DateTime: 2004/03/30 17:47:27 $";
