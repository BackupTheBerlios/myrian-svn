...
public class AssociationMetadataTest extends TestCase {
    ...
    public final static String versionId = "$Id: //core-platform/dev/test/src/com/arsdigita/persistence/pdl/AssociationMetadataTest.java#5 $ by $Author: dennis $, $DateTime: 2004/08/16 18:10:38 $";
