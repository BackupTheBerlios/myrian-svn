 ...
 * @version $Revision: #1 $ $Date: 2003/09/05 $
 **/

public class AssociationMetadataTest extends TestCase {

    public final static String versionId = "$Id: //core-platform/dev/test/src/com/arsdigita/persistence/pdl/AssociationMetadataTest.java#1 $ by $Author: ashah $, $DateTime: 2003/09/05 16:00:14 $";
