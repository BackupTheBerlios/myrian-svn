...
public class DynamicLinkAttributeTest extends LinkAttributeTest {
    ...
    public final static String versionId = "$Id: //core-platform/dev/test/src/com/arsdigita/persistence/DynamicLinkAttributeTest.java#6 $ by $Author: dennis $, $DateTime: 2003/08/15 13:46:34 $";
