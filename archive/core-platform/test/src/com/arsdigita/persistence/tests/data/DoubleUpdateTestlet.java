...
public class DoubleUpdateTestlet extends Testlet {
    ...
    public final static String versionId = "$Id: //core-platform/dev/test/src/com/arsdigita/persistence/tests/data/DoubleUpdateTestlet.java#4 $ by $Author: dennis $, $DateTime: 2004/03/30 17:47:27 $";
