 ...
 * @version $Revision: #1 $ $Date: 2002/11/06 $
 **/

public class MappingsTest extends BaseTestCase {

    public final static String versionId = "$Id: //core-platform/dev/test/src/com/arsdigita/persistence/tests/data/MappingsTest.java#1 $ by $Author: rhs $, $DateTime: 2002/11/06 16:38:23 $";
