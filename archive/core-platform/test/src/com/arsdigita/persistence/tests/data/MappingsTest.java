...
public class MappingsTest extends BaseTestCase {
    ...
    public final static String versionId = "$Id: //core-platform/dev/test/src/com/arsdigita/persistence/tests/data/MappingsTest.java#9 $ by $Author: dennis $, $DateTime: 2004/08/16 18:10:38 $";
