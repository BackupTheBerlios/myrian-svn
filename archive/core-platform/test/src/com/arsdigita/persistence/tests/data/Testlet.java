...
public abstract class Testlet {
    ...
    public final static String versionId = "$Id: //core-platform/dev/test/src/com/arsdigita/persistence/tests/data/Testlet.java#7 $ by $Author: dennis $, $DateTime: 2004/03/30 17:47:27 $";
