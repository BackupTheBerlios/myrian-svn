...
public class PropertyIsolationTestlet extends Testlet {
    ...
    public final static String versionId = "$Id: //core-platform/dev/test/src/com/arsdigita/persistence/tests/data/PropertyIsolationTestlet.java#3 $ by $Author: dennis $, $DateTime: 2004/03/30 17:47:27 $";
