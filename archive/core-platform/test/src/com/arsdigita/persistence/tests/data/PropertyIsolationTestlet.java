...
public class PropertyIsolationTestlet extends Testlet {
    ...
    public final static String versionId = "$Id: //core-platform/dev/test/src/com/arsdigita/persistence/tests/data/PropertyIsolationTestlet.java#5 $ by $Author: dennis $, $DateTime: 2004/08/16 18:10:38 $";
