...
public class PropertyIsolationTestlet extends Testlet {
    ...
    public final static String versionId = "$Id: //core-platform/dev/test/src/com/arsdigita/persistence/tests/data/PropertyIsolationTestlet.java#2 $ by $Author: dennis $, $DateTime: 2003/08/15 13:46:34 $";
