...
public class ObjectTree {
    ...
    public final static String versionId = "$Id: //core-platform/dev/test/src/com/arsdigita/persistence/tests/data/ObjectTree.java#1 $ by $Author: rhs $, $DateTime: 2002/10/31 12:25:15 $";
