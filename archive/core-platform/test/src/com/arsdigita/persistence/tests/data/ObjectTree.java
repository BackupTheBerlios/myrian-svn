...
public class ObjectTree {
    ...
    public final static String versionId = "$Id: //core-platform/dev/test/src/com/arsdigita/persistence/tests/data/ObjectTree.java#3 $ by $Author: dennis $, $DateTime: 2003/08/15 13:46:34 $";
