...
public class StaticPartyTest extends PartyTest {
    ...
    public final static String versionId = "$Id: //core-platform/dev/test/src/com/arsdigita/persistence/StaticPartyTest.java#6 $ by $Author: dennis $, $DateTime: 2004/03/30 17:47:27 $";
