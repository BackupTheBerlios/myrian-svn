...
public class StaticPartyTest extends PartyTest {
    ...
    public final static String versionId = "$Id: //core-platform/dev/test/src/com/arsdigita/persistence/StaticPartyTest.java#5 $ by $Author: dennis $, $DateTime: 2003/08/15 13:46:34 $";
