...
public class RefetchTest extends PersistenceTestCase {
    ...
    public final static String versionId = "$Id: //core-platform/dev/test/src/com/arsdigita/persistence/RefetchTest.java#10 $ by $Author: dennis $, $DateTime: 2004/08/16 18:10:38 $";
