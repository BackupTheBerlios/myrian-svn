 ...
 * @version $Revision: #15 $ $Date: 2003/10/23 $
 */
public class DataOperationTest extends PersistenceTestCase {

    public final static String versionId = "$Id: //core-platform/dev/test/src/com/arsdigita/persistence/DataOperationTest.java#15 $ by $Author: justin $, $DateTime: 2003/10/23 15:28:18 $";
