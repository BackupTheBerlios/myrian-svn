...
public class OQLSuite extends PackageTestSuite {
    ...
    public final static String versionId = "$Id: //core-platform/dev/test/src/com/arsdigita/persistence/oql/OQLSuite.java#8 $ by $Author: dennis $, $DateTime: 2004/04/07 16:07:11 $";
