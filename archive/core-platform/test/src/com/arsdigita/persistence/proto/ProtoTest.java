...
public class ProtoTest extends TestCase {
    ...
    public final static String versionId = "$Id: //core-platform/dev/test/src/com/arsdigita/persistence/proto/ProtoTest.java#1 $ by $Author: ashah $, $DateTime: 2003/05/12 18:19:45 $";
