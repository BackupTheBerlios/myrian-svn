...
public class MetaTest extends PersistenceTestCase {
    ...
    public final static String versionId = "$Id: //core-platform/dev/test/src/com/arsdigita/persistence/MetaTest.java#13 $ by $Author: dennis $, $DateTime: 2004/03/30 17:47:27 $";
