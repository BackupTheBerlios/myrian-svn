...
public class StaticOrderTest extends OrderTest {
    ...
    public final static String versionId = "$Id: //core-platform/dev/test/src/com/arsdigita/persistence/StaticOrderTest.java#4 $ by $Author: dennis $, $DateTime: 2003/08/15 13:46:34 $";
