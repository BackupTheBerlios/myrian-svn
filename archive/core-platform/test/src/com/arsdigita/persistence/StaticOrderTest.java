...
public class StaticOrderTest extends OrderTest {
    ...
    public final static String versionId = "$Id: //core-platform/dev/test/src/com/arsdigita/persistence/StaticOrderTest.java#6 $ by $Author: dennis $, $DateTime: 2004/04/07 16:07:11 $";
