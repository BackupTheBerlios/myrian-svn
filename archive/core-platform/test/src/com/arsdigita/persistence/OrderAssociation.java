...
final class OrderAssociation {
    ...
    public static final String versionId = "$Id: //core-platform/dev/test/src/com/arsdigita/persistence/OrderAssociation.java#7 $ by $Author: dennis $, $DateTime: 2004/03/30 17:47:27 $";
