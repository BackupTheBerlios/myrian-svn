...
final class OrderAssociation {
    ...
    public static final String versionId = "$Id: //core-platform/dev/test/src/com/arsdigita/persistence/OrderAssociation.java#9 $ by $Author: dennis $, $DateTime: 2004/08/16 18:10:38 $";
