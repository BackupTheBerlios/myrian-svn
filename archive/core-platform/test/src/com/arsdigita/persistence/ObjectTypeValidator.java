...
public class ObjectTypeValidator  {
    ...
    public final static String versionId = "$Id: //core-platform/dev/test/src/com/arsdigita/persistence/ObjectTypeValidator.java#1 $ by $Author: dennis $, $DateTime: 2002/05/12 18:23:13 $";
