...
public class TagTestElement {
    ...
    public static final String versionId = "$Id: //core-platform/dev/test/src/com/arsdigita/xml/TagTestElement.java#6 $ by $Author: dennis $, $DateTime: 2004/04/07 16:07:11 $";
