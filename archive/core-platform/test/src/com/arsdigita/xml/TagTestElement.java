...
public class TagTestElement {
    ...
    public static final String versionId = "$Id: //core-platform/dev/test/src/com/arsdigita/xml/TagTestElement.java#4 $ by $Author: dennis $, $DateTime: 2003/08/15 13:46:34 $";
