...
public class TagTestElement {
    ...
    public static final String versionId = "$Id: //core-platform/dev/test/src/com/arsdigita/xml/TagTestElement.java#7 $ by $Author: dennis $, $DateTime: 2004/08/16 18:10:38 $";
