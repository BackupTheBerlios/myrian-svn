...
public class TagTestElement {
    ...
    public static final String versionId = "$Id: //core-platform/dev/test/src/com/arsdigita/xml/TagTestElement.java#5 $ by $Author: dennis $, $DateTime: 2004/03/30 17:47:27 $";
