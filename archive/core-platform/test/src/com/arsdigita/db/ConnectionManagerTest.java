...
public class ConnectionManagerTest extends TestCase {
    ...
    public static final String versionId = "$Id: //core-platform/dev/test/src/com/arsdigita/db/ConnectionManagerTest.java#12 $ by $Author: dennis $, $DateTime: 2004/08/16 18:10:38 $";
