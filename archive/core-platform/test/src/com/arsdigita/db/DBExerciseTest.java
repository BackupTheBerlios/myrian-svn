...
public class DBExerciseTest extends TestCase {
    ...
    public static final String versionId = "$Id: //core-platform/dev/test/src/com/arsdigita/db/DBExerciseTest.java#8 $ by $Author: dennis $, $DateTime: 2004/03/30 17:47:27 $";
