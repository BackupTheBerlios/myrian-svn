...
public class DBExerciseTest extends TestCase {
    ...
    public static final String versionId = "$Id: //core-platform/dev/test/src/com/arsdigita/db/DBExerciseTest.java#5 $ by $Author: dennis $, $DateTime: 2002/12/11 13:49:53 $";
