...
public class DBExerciseTest extends TestCase {
    ...
    public static final String versionId = "$Id: //core-platform/dev/test/src/com/arsdigita/db/DBExerciseTest.java#7 $ by $Author: jorris $, $DateTime: 2004/01/29 17:51:04 $";
