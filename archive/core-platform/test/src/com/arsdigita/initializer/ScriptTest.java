...
public class ScriptTest extends TestCase {
    ...
    public final static String versionId = "$Id: //core-platform/dev/test/src/com/arsdigita/initializer/ScriptTest.java#5 $ by $Author: dennis $, $DateTime: 2003/08/15 13:46:34 $";
