...
public class FooInitializer implements Initializer {
    ...
    public final static String versionId = "$Id: //core-platform/dev/test/src/com/arsdigita/initializer/FooInitializer.java#3 $ by $Author: dennis $, $DateTime: 2002/08/14 23:39:40 $";
