...
public class FooInitializer implements Initializer {
    ...
    public final static String versionId = "$Id: //core-platform/dev/test/src/com/arsdigita/initializer/FooInitializer.java#6 $ by $Author: dennis $, $DateTime: 2004/04/07 16:07:11 $";
