...
public class ProtoSuite extends PackageTestSuite {
    ...
    public final static String versionId = "$Id: //core-platform/dev/test/src/com/redhat/persistence/ProtoSuite.java#8 $ by $Author: dennis $, $DateTime: 2004/08/16 18:10:38 $";
