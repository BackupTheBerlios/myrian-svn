...
public class ProtoTest extends TestCase {
    ...
    public final static String versionId = "$Id: //core-platform/dev/test/src/com/redhat/persistence/ProtoTest.java#5 $ by $Author: dennis $, $DateTime: 2004/03/30 17:47:27 $";
