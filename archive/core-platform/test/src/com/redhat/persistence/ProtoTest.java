...
public class ProtoTest extends TestCase {
    ...
    public final static String versionId = "$Id: //core-platform/dev/test/src/com/redhat/persistence/ProtoTest.java#7 $ by $Author: dennis $, $DateTime: 2004/08/16 18:10:38 $";
