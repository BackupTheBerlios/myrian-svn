...
public class QueryTest extends TestCase {
    ...
    public final static String versionId = "$Id: //core-platform/dev/test/src/com/redhat/persistence/oql/QueryTest.java#1 $ by $Author: vadim $, $DateTime: 2004/03/11 18:13:02 $";
