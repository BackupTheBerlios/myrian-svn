...
class MultiSet {
    ...
    public final static String versionId = "$Id: //core-platform/dev/test/src/com/redhat/persistence/oql/MultiSet.java#2 $ by $Author: dennis $, $DateTime: 2004/03/30 17:47:27 $";
