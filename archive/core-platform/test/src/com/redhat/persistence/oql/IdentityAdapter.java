...
public class IdentityAdapter extends Adapter {
    ...
    public final static String versionId = "$Id: //core-platform/dev/test/src/com/redhat/persistence/oql/IdentityAdapter.java#4 $ by $Author: dennis $, $DateTime: 2004/08/16 18:10:38 $";
