...
public class InitializationException extends UncheckedWrapperException {
    ...
    public final static String versionId = "$Id: //core-platform/dev/src/com/arsdigita/initializer/InitializationException.java#4 $ by $Author: dennis $, $DateTime: 2003/08/15 13:46:34 $";
