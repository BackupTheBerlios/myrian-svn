 ...
 * @version $Id: //core-platform/dev/src/com/arsdigita/db/ResultSetEvent.java#3 $
 * @since 4.6
 */
public class ResultSetEvent extends java.util.EventObject {

    public static final String versionId = "$Id: //core-platform/dev/src/com/arsdigita/db/ResultSetEvent.java#3 $ by $Author: dennis $, $DateTime: 2002/08/14 23:39:40 $";
