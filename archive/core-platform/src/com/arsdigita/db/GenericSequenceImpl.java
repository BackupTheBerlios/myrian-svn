...
public class GenericSequenceImpl extends SequenceImpl {
    ...
    public static final String versionId = "$Id: //core-platform/dev/src/com/arsdigita/db/GenericSequenceImpl.java#5 $ by $Author: dennis $, $DateTime: 2003/08/15 13:46:34 $";
