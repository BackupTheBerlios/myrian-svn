...
public interface ConnectionUseListener {
    ...
    public static final String versionId = "$Id: //core-platform/dev/src/com/arsdigita/db/ConnectionUseListener.java#2 $ by $Author: dennis $, $DateTime: 2002/07/18 13:18:21 $";
