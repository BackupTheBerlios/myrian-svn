...
public class OracleSequenceImpl extends SequenceImpl {
    ...
    public static final String versionId = "$Id: //core-platform/dev/src/com/arsdigita/db/oracle/OracleSequenceImpl.java#9 $ by $Author: dennis $, $DateTime: 2004/04/07 16:07:11 $";
