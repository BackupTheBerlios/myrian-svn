...
public class OracleSequenceImpl extends SequenceImpl {
    ...
    public static final String versionId = "$Id: //core-platform/dev/src/com/arsdigita/db/oracle/OracleSequenceImpl.java#1 $ by $Author: dennis $, $DateTime: 2002/05/12 18:23:13 $";
