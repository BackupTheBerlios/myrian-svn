...
public class OracleSequenceImpl extends SequenceImpl {
    ...
    public static final String versionId = "$Id: //core-platform/dev/src/com/arsdigita/db/oracle/OracleSequenceImpl.java#2 $ by $Author: dennis $, $DateTime: 2002/07/18 13:18:21 $";
