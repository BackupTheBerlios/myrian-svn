 ...
 *
 * @author David Eison
 * @version $Id: //core-platform/dev/src/com/arsdigita/db/ResultSetEventListener.java#5 $
 * @since 4.6
 */
public interface ResultSetEventListener extends java.util.EventListener {

    public static final String versionId = "$Id: //core-platform/dev/src/com/arsdigita/db/ResultSetEventListener.java#5 $ by $Author: dennis $, $DateTime: 2003/08/15 13:46:34 $";
