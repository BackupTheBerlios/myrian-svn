 ...
 * @version $Id: //core-platform/dev/src/com/arsdigita/db/postgres/PostgresConnectionPoolImpl.java#9 $ $DateTime: 2003/08/15 13:46:34 $
 * @since 4.5
 *
 */
...
public class PostgresConnectionPoolImpl extends BaseConnectionPool {
    ...
    public static final String versionId = "$Author: dennis $ - $Date: 2003/08/15 $ $Id: //core-platform/dev/src/com/arsdigita/db/postgres/PostgresConnectionPoolImpl.java#9 $";
