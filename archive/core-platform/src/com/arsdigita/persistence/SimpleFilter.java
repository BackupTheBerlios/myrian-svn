...
class SimpleFilter extends FilterImpl {
    ...
    public final static String versionId = "$Id: //core-platform/dev/src/com/arsdigita/persistence/SimpleFilter.java#5 $ by $Author: dennis $, $DateTime: 2004/03/30 17:47:27 $";
