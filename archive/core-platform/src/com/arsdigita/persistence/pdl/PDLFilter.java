...
public interface PDLFilter {
    ...
    public final static String versionId = "$Id: //core-platform/dev/src/com/arsdigita/persistence/pdl/PDLFilter.java#4 $ by $Author: dennis $, $DateTime: 2004/03/30 17:47:27 $";
