...
public interface PDLFilter {
    ...
    public final static String versionId = "$Id: //core-platform/dev/src/com/arsdigita/persistence/pdl/PDLFilter.java#6 $ by $Author: dennis $, $DateTime: 2004/08/16 18:10:38 $";
