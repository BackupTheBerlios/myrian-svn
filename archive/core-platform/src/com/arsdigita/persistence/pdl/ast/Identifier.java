...
public class Identifier extends Element {
    ...
    public final static String versionId = "$Id: //core-platform/dev/src/com/arsdigita/persistence/pdl/ast/Identifier.java#2 $ by $Author: dennis $, $DateTime: 2002/07/18 13:18:21 $";
