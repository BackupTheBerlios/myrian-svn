...
public class BindingDef extends MapStatement {
    ...
    public final static String versionId = "$Id: //core-platform/dev/src/com/arsdigita/persistence/pdl/ast/BindingDef.java#3 $ by $Author: dennis $, $DateTime: 2002/08/14 23:39:40 $";
