...
public class NameFilter implements PDLFilter {
    ...
    public final static String versionId = "$Id: //core-platform/dev/src/com/arsdigita/persistence/pdl/NameFilter.java#1 $ by $Author: justin $, $DateTime: 2003/09/26 16:16:05 $";
