...
public class ManifestSource implements PDLSource {
    ...
    public final static String versionId = "$Id: //core-platform/dev/src/com/arsdigita/persistence/pdl/ManifestSource.java#7 $ by $Author: dennis $, $DateTime: 2004/08/16 18:10:38 $";
