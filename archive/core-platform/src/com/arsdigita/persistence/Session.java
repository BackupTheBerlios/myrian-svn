...
public class Session {
     ...
     *
     * @param root The MetadataRoot used to do qualified type name lookups.
     **/
    Session(com.arsdigita.persistence.metadata.MetadataRoot root) {
    ...
    public TransactionContext getTransactionContext() {
        return m_dataStore.getTransactionContext();
    }
    ...
    public Connection getConnection() {
        return m_dataStore.getConnection();
    }
