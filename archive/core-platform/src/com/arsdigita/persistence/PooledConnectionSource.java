...
public class PooledConnectionSource implements ConnectionSource {
    ...
    public final static String versionId = "$Id: //core-platform/dev/src/com/arsdigita/persistence/PooledConnectionSource.java#3 $ by $Author: dennis $, $DateTime: 2004/03/30 17:47:27 $";
