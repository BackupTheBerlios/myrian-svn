...
abstract public class ModelElement extends Element {
    ...
    public final static String versionId = "$Id: //core-platform/dev/src/com/arsdigita/persistence/metadata/ModelElement.java#7 $ by $Author: dennis $, $DateTime: 2004/03/30 17:47:27 $";
