...
abstract public class ModelElement extends Element {
    ...
    public final static String versionId = "$Id: //core-platform/dev/src/com/arsdigita/persistence/metadata/ModelElement.java#9 $ by $Author: dennis $, $DateTime: 2004/08/16 18:10:38 $";
