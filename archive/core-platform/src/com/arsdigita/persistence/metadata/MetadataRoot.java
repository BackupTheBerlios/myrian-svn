...
public class MetadataRoot extends Element {
    ...
    public final static String versionId = "$Id: //core-platform/dev/src/com/arsdigita/persistence/metadata/MetadataRoot.java#14 $ by $Author: jorris $, $DateTime: 2003/02/19 22:26:51 $";
    ...
    public static final SimpleType CHARACTER = init
        (new SimpleType("Character", java.lang.Character.class, Types.CHAR) {
                public int bindValue(PreparedStatement ps, int index, Object value,
                    ...
                    if (charValue == null || "".equals(charValue.toString())) {
                        ps.setString(index, null);
                    } else {
                        ps.setString(index, charValue.toString());
                    }
                    return 1;
                }
        ...
        init(new SimpleType("Blob", java.sql.Blob.class, Types.BLOB) {
                ...
                public int bindValue(PreparedStatement ps, int index, Object value,
                    ...
                    if (DbHelper.getDatabase() == DbHelper.DB_POSTGRES) {
                        ...
                        //System.out.println("lenxx= " + bytes.length);
                        byte[] l_bytes = new byte[bytes.length];
                        int l_bytesRead;
                        l_bytesRead = (new ByteArrayInputStream(bytes)).read(l_bytes, 0, bytes.length);
