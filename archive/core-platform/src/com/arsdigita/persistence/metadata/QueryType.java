...
public class QueryType extends CompoundType {
    ...
    public final static String versionId = "$Id: //core-platform/dev/src/com/arsdigita/persistence/metadata/QueryType.java#2 $ by $Author: dennis $, $DateTime: 2002/07/18 13:18:21 $";
