...
public class DedicatedConnectionSource implements ConnectionSource {
    ...
    public final static String versionId = "$Id: //core-platform/dev/src/com/arsdigita/persistence/DedicatedConnectionSource.java#5 $ by $Author: dennis $, $DateTime: 2004/08/16 18:10:38 $";
