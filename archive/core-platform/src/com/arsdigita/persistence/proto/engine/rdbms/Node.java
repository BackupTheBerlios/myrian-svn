...
class Node {
    ...
    public final static String versionId = "$Id: //core-platform/dev/src/com/arsdigita/persistence/proto/engine/rdbms/Node.java#1 $ by $Author: rhs $, $DateTime: 2003/06/09 19:03:29 $";
