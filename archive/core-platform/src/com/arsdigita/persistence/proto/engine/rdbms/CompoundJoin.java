...
abstract class CompoundJoin extends Join {
    ...
    public final static String versionId = "$Id: //core-platform/dev/src/com/arsdigita/persistence/proto/engine/rdbms/CompoundJoin.java#1 $ by $Author: ashah $, $DateTime: 2003/05/12 18:19:45 $";
