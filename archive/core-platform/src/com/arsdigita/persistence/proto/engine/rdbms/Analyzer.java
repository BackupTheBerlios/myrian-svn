 ...
 * @version $Revision: #1 $ $Date: 2003/06/24 $
 **/

class Analyzer {

    public final static String versionId = "$Id: //core-platform/dev/src/com/arsdigita/persistence/proto/engine/rdbms/Analyzer.java#1 $ by $Author: rhs $, $DateTime: 2003/06/24 22:57:54 $";
