...
public class SQL {
    ...
    public final static String versionId = "$Id: //core-platform/dev/src/com/arsdigita/persistence/proto/common/SQL.java#1 $ by $Author: ashah $, $DateTime: 2003/05/12 18:19:45 $";
