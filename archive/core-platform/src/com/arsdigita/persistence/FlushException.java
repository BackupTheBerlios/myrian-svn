...
public class FlushException extends PersistenceException {
    ...
    public static final String versionId = "$Id: //core-platform/dev/src/com/arsdigita/persistence/FlushException.java#3 $ by $Author: dennis $, $DateTime: 2004/03/30 17:47:27 $";
