...
public class FlushException extends PersistenceException {
    ...
    public static final String versionId = "$Id: //core-platform/dev/src/com/arsdigita/persistence/FlushException.java#5 $ by $Author: dennis $, $DateTime: 2004/08/16 18:10:38 $";
