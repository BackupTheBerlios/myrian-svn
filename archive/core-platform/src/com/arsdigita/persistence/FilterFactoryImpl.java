...
class FilterFactoryImpl implements FilterFactory {
    ...
    public final static String versionId = "$Id: //core-platform/dev/src/com/arsdigita/persistence/FilterFactoryImpl.java#8 $ by $Author: dennis $, $DateTime: 2004/03/30 17:47:27 $";
