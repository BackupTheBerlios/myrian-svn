 ...
 * @version $Id: //core-platform/dev/src/com/arsdigita/util/parameter/ParameterWriter.java#6 $
 */
public interface ParameterWriter {
    public final static String versionId =
        "$Id: //core-platform/dev/src/com/arsdigita/util/parameter/ParameterWriter.java#6 $" +
        "$Author: dennis $" +
