 ...
 * @version $Id: //core-platform/dev/src/com/arsdigita/util/parameter/Converters.java#6 $
 */
public class Converters {
    public final static String versionId =
        "$Id: //core-platform/dev/src/com/arsdigita/util/parameter/Converters.java#6 $" +
        "$Author: dennis $" +
