 ...
 * @version $Id: //core-platform/dev/src/com/arsdigita/util/parameter/MapParameter.java#4 $
 */
public class MapParameter extends AbstractParameter {
    public final static String versionId =
        "$Id: //core-platform/dev/src/com/arsdigita/util/parameter/MapParameter.java#4 $" +
        "$Author: dennis $" +
