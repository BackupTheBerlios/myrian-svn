 ...
 * @version $Id: //core-platform/dev/src/com/arsdigita/util/parameter/ParameterException.java#7 $
 */
public final class ParameterException extends RuntimeException {
    public final static String versionId =
        "$Id: //core-platform/dev/src/com/arsdigita/util/parameter/ParameterException.java#7 $" +
        "$Author: dennis $" +
