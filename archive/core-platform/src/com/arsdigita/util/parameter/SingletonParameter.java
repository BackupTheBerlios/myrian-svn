 ...
 * @version $Id: //core-platform/dev/src/com/arsdigita/util/parameter/SingletonParameter.java#7 $
 */
public class SingletonParameter extends ClassParameter {
    public final static String versionId =
        "$Id: //core-platform/dev/src/com/arsdigita/util/parameter/SingletonParameter.java#7 $" +
        "$Author: dennis $" +
