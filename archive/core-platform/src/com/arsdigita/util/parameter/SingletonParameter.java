 ...
 * @version $Id: //core-platform/dev/src/com/arsdigita/util/parameter/SingletonParameter.java#5 $
 */
public class SingletonParameter extends ClassParameter {
    public final static String versionId =
        "$Id: //core-platform/dev/src/com/arsdigita/util/parameter/SingletonParameter.java#5 $" +
        "$Author: dennis $" +
