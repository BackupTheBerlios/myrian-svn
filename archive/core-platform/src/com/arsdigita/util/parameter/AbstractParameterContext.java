 ...
 * @version $Id: //core-platform/dev/src/com/arsdigita/util/parameter/AbstractParameterContext.java#9 $
 */
public abstract class AbstractParameterContext implements ParameterContext {
    public final static String versionId =
        "$Id: //core-platform/dev/src/com/arsdigita/util/parameter/AbstractParameterContext.java#9 $" +
        "$Author: dennis $" +
