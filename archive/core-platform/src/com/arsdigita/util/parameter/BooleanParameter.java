 ...
 * @version $Id: //core-platform/dev/src/com/arsdigita/util/parameter/BooleanParameter.java#7 $
 */
public class BooleanParameter extends AbstractParameter {
    public final static String versionId =
        "$Id: //core-platform/dev/src/com/arsdigita/util/parameter/BooleanParameter.java#7 $" +
        "$Author: dennis $" +
