 ...
 * @version $Id: //core-platform/dev/src/com/arsdigita/util/parameter/AbstractParameter.java#7 $
 */
public abstract class AbstractParameter implements Parameter {
    public final static String versionId =
        "$Id: //core-platform/dev/src/com/arsdigita/util/parameter/AbstractParameter.java#7 $" +
        "$Author: dennis $" +
