 ...
 * @version $Id: //core-platform/dev/src/com/arsdigita/util/parameter/ParameterError.java#6 $
 */
public final class ParameterError {
    public final static String versionId =
        "$Id: //core-platform/dev/src/com/arsdigita/util/parameter/ParameterError.java#6 $" +
        "$Author: dennis $" +
