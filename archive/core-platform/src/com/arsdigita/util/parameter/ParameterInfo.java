 ...
 * @version $Id: //core-platform/dev/src/com/arsdigita/util/parameter/ParameterInfo.java#6 $
 */
public interface ParameterInfo {
    public final static String versionId =
        "$Id: //core-platform/dev/src/com/arsdigita/util/parameter/ParameterInfo.java#6 $" +
        "$Author: dennis $" +
