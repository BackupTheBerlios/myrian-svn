 ...
 * @version $Id: //core-platform/dev/src/com/arsdigita/util/parameter/StringParameter.java#7 $
 */
public class StringParameter extends AbstractParameter {
    public final static String versionId =
        "$Id: //core-platform/dev/src/com/arsdigita/util/parameter/StringParameter.java#7 $" +
        "$Author: dennis $" +
