 ...
 * @version $Id: //core-platform/dev/src/com/arsdigita/util/parameter/CompoundParameterReader.java#4 $
 */
public class CompoundParameterReader implements ParameterReader {
    public final static String versionId =
        "$Id: //core-platform/dev/src/com/arsdigita/util/parameter/CompoundParameterReader.java#4 $" +
        "$Author: dennis $" +
