 ...
 * @version $Id: //core-platform/dev/src/com/arsdigita/util/parameter/CompoundParameterReader.java#6 $
 */
public class CompoundParameterReader implements ParameterReader {
    public final static String versionId =
        "$Id: //core-platform/dev/src/com/arsdigita/util/parameter/CompoundParameterReader.java#6 $" +
        "$Author: dennis $" +
