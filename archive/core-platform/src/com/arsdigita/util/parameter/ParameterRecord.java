 ...
 * @version $Id: //core-platform/dev/src/com/arsdigita/util/parameter/ParameterRecord.java#1 $
 */
public abstract class ParameterRecord {
    public final static String versionId =
        "$Id: //core-platform/dev/src/com/arsdigita/util/parameter/ParameterRecord.java#1 $" +
        "$Author: justin $" +
