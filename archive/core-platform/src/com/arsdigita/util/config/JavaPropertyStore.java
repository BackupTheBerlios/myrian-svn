 ...
 * @version $Id: //core-platform/dev/src/com/arsdigita/util/config/JavaPropertyStore.java#1 $
 */
public class JavaPropertyStore implements ParameterStore {
    public final static String versionId =
        "$Id: //core-platform/dev/src/com/arsdigita/util/config/JavaPropertyStore.java#1 $" +
        "$Author: justin $" +
