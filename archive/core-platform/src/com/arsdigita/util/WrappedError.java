 ...
 *
 * @since   2004-01-19
 * @version $Id: //core-platform/dev/src/com/arsdigita/util/WrappedError.java#2 $
 */
public class WrappedError extends Error {

    public static final String versionId = "$Id: //core-platform/dev/src/com/arsdigita/util/WrappedError.java#2 $";
