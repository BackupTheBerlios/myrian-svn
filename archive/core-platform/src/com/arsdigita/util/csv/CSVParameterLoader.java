 ...
 * @version $Id: //core-platform/dev/src/com/arsdigita/util/csv/CSVParameterLoader.java#6 $
 */
public final class CSVParameterLoader implements ParameterLoader {
    public final static String versionId =
        "$Id: //core-platform/dev/src/com/arsdigita/util/csv/CSVParameterLoader.java#6 $" +
        "$Author: dennis $" +
