 ...
 * @version $Id: //core-platform/dev/src/com/arsdigita/util/servlet/HttpParameterListener.java#1 $
 */
public interface HttpParameterListener {
    static final String versionId =
        "$Id: //core-platform/dev/src/com/arsdigita/util/servlet/HttpParameterListener.java#1 $" +
        "$Author: justin $" +
