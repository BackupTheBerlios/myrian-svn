...
public class BooleanSwitch extends Switch {
    ...
    public final static String versionId = "$Id: //core-platform/dev/src/com/arsdigita/util/cmd/BooleanSwitch.java#7 $ by $Author: dennis $, $DateTime: 2004/08/16 18:10:38 $";
