...
public class BooleanSwitch extends Switch {
    ...
    public final static String versionId = "$Id: //core-platform/dev/src/com/arsdigita/util/cmd/BooleanSwitch.java#3 $ by $Author: dennis $, $DateTime: 2003/08/15 13:46:34 $";
