...
public class StringSwitch extends Switch {
    ...
    public final static String versionId = "$Id: //core-platform/dev/src/com/arsdigita/util/cmd/StringSwitch.java#6 $ by $Author: dennis $, $DateTime: 2004/04/07 16:07:11 $";
