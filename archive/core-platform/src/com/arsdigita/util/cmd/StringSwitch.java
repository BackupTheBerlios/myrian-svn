...
public class StringSwitch extends Switch {
    ...
    public final static String versionId = "$Id: //core-platform/dev/src/com/arsdigita/util/cmd/StringSwitch.java#2 $ by $Author: dennis $, $DateTime: 2003/01/07 14:51:38 $";
