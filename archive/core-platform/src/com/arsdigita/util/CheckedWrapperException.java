 ...
 *
 * @author David Eison 
 * @version $Id: //core-platform/dev/src/com/arsdigita/util/CheckedWrapperException.java#8 $
 */
public class CheckedWrapperException extends Exception {

    public static final String versionId = "$Id: //core-platform/dev/src/com/arsdigita/util/CheckedWrapperException.java#8 $";
