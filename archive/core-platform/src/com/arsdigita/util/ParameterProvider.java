...
public interface ParameterProvider {
    ...
    public static final String versionId = "$Id: //core-platform/dev/src/com/arsdigita/util/ParameterProvider.java#5 $ by $Author: dennis $, $DateTime: 2004/03/30 17:47:27 $";
    /**
