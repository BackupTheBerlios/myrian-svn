...
public interface ParameterProvider {
    ...
    public static final String versionId = "$Id: //core-platform/dev/src/com/arsdigita/util/ParameterProvider.java#6 $ by $Author: dennis $, $DateTime: 2004/04/07 16:07:11 $";
    /**
