...
public interface ParameterProvider {
    ...
    public static final String versionId = "$Id: //core-platform/dev/src/com/arsdigita/util/ParameterProvider.java#4 $ by $Author: dennis $, $DateTime: 2003/08/15 13:46:34 $";
    /**
