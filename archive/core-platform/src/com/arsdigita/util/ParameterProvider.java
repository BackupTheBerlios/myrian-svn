...
public interface ParameterProvider {
    ...
    public static final String versionId = "$Id: //core-platform/dev/src/com/arsdigita/util/ParameterProvider.java#7 $ by $Author: dennis $, $DateTime: 2004/08/16 18:10:38 $";
    /**
