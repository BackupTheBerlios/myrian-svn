 ...
 * @version $Id: //core-platform/dev/src/com/arsdigita/util/jdbc/JDBCURLParameter.java#6 $
 */
public class JDBCURLParameter extends StringParameter {
    public final static String versionId =
        "$Id: //core-platform/dev/src/com/arsdigita/util/jdbc/JDBCURLParameter.java#6 $" +
        "$Author: dennis $" +
