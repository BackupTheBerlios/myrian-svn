...
public abstract class UnaryCondition extends Condition {
    ...
    public final static String versionId = "$Id: //core-platform/dev/src/com/redhat/persistence/oql/UnaryCondition.java#3 $ by $Author: dennis $, $DateTime: 2004/03/30 17:47:27 $";
