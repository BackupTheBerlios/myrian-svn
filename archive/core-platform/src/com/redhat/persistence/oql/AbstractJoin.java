...
public abstract class AbstractJoin extends Expression {
    ...
    public final static String versionId = "$Id: //core-platform/dev/src/com/redhat/persistence/oql/AbstractJoin.java#3 $ by $Author: rhs $, $DateTime: 2004/03/28 22:52:45 $";
