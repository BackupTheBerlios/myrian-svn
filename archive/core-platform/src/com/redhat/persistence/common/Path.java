...
public class Path {
    ...
    public final static String versionId = "$Id: //core-platform/dev/src/com/redhat/persistence/common/Path.java#15 $ by $Author: dennis $, $DateTime: 2004/08/16 18:10:38 $";
