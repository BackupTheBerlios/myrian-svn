...
public final class CompoundKey {
    ...
    public final static String versionId = "$Id: //core-platform/dev/src/com/redhat/persistence/common/CompoundKey.java#1 $ by $Author: rhs $, $DateTime: 2003/07/08 21:04:28 $";
