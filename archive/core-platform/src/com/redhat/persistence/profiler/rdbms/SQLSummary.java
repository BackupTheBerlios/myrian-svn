...
class SQLSummary {
    ...
    public final static String versionId = "$Id: //core-platform/dev/src/com/redhat/persistence/profiler/rdbms/SQLSummary.java#6 $ by $Author: dennis $, $DateTime: 2004/08/16 18:10:38 $";
