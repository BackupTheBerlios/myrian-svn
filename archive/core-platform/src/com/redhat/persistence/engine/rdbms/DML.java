...
abstract class DML extends Operation {
    ...
    public final static String versionId = "$Id: //core-platform/dev/src/com/redhat/persistence/engine/rdbms/DML.java#5 $ by $Author: dennis $, $DateTime: 2004/03/30 17:47:27 $";
