...
abstract class DML extends Operation {
    ...
    public final static String versionId = "$Id: //core-platform/dev/src/com/redhat/persistence/engine/rdbms/DML.java#7 $ by $Author: dennis $, $DateTime: 2004/08/16 18:10:38 $";
