...
class StaticJoin extends Join {
    ...
    public final static String versionId = "$Id: //core-platform/dev/src/com/redhat/persistence/engine/rdbms/StaticJoin.java#3 $ by $Author: jorris $, $DateTime: 2003/10/28 18:36:21 $";
