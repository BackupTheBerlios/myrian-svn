...
abstract class CompoundJoin extends Join {
    ...
    public final static String versionId = "$Id: //core-platform/dev/src/com/redhat/persistence/engine/rdbms/CompoundJoin.java#6 $ by $Author: dennis $, $DateTime: 2004/08/16 18:10:38 $";
