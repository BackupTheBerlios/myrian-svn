...
class StaticQuerySource extends QuerySource {
    ...
    public final static String versionId = "$Id: //core-platform/dev/src/com/redhat/persistence/engine/rdbms/StaticQuerySource.java#2 $ by $Author: dennis $, $DateTime: 2003/08/15 13:46:34 $";
