...
class EventSwitch extends Event.Switch {
    ...
    public final static String versionId = "$Id: //core-platform/dev/src/com/redhat/persistence/engine/rdbms/EventSwitch.java#8 $ by $Author: dennis $, $DateTime: 2004/03/30 17:47:27 $";
