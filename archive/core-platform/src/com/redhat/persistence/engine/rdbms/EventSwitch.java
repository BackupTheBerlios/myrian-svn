...
class EventSwitch extends Event.Switch {
    ...
    public final static String versionId = "$Id: //core-platform/dev/src/com/redhat/persistence/engine/rdbms/EventSwitch.java#10 $ by $Author: dennis $, $DateTime: 2004/08/16 18:10:38 $";
