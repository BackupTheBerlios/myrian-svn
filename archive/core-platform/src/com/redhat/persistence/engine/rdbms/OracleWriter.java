...
public class OracleWriter extends ANSIWriter {
    ...
    public final static String versionId = "$Id: //core-platform/dev/src/com/redhat/persistence/engine/rdbms/OracleWriter.java#6 $ by $Author: dennis $, $DateTime: 2004/03/30 17:47:27 $";
