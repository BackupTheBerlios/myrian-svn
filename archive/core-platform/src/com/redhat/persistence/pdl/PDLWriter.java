...
public class PDLWriter {
    ...
    public final static String versionId = "$Id: //core-platform/dev/src/com/redhat/persistence/pdl/PDLWriter.java#8 $ by $Author: dennis $, $DateTime: 2004/08/16 18:10:38 $";
