...
public class PDLWriter {
    ...
    public final static String versionId = "$Id: //core-platform/dev/src/com/redhat/persistence/pdl/PDLWriter.java#6 $ by $Author: dennis $, $DateTime: 2004/03/30 17:47:27 $";
