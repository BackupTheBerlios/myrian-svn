...
public class PDLWriter {
    ...
    public final static String versionId = "$Id: //core-platform/dev/src/com/redhat/persistence/pdl/PDLWriter.java#5 $ by $Author: vadim $, $DateTime: 2004/03/11 18:13:02 $";
