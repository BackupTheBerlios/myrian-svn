...
public class JoinNd extends Node {
    ...
    public final static String versionId = "$Id: //core-platform/dev/src/com/redhat/persistence/pdl/nodes/JoinNd.java#5 $ by $Author: dennis $, $DateTime: 2004/08/16 18:10:38 $";
