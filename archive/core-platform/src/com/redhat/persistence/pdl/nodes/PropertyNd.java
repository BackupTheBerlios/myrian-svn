...
public class PropertyNd extends StatementNd {
    ...
    public final static String versionId = "$Id: //core-platform/dev/src/com/redhat/persistence/pdl/nodes/PropertyNd.java#5 $ by $Author: dennis $, $DateTime: 2004/08/16 18:10:38 $";
