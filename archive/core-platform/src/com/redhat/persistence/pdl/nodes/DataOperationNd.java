...
public class DataOperationNd extends Node {
    ...
    public final static String versionId = "$Id: //core-platform/dev/src/com/redhat/persistence/pdl/nodes/DataOperationNd.java#4 $ by $Author: dennis $, $DateTime: 2004/04/07 16:07:11 $";
