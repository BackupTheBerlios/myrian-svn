...
public class ModelNd extends Node {
    ...
    public final static String versionId = "$Id: //core-platform/dev/src/com/redhat/persistence/pdl/nodes/ModelNd.java#2 $ by $Author: dennis $, $DateTime: 2003/08/15 13:46:34 $";
