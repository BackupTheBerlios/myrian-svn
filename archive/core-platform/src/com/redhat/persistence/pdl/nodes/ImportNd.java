...
public class ImportNd extends Node {
    ...
    public final static String versionId = "$Id: //core-platform/dev/src/com/redhat/persistence/pdl/nodes/ImportNd.java#3 $ by $Author: dennis $, $DateTime: 2004/03/30 17:47:27 $";
