...
public class FileNd extends Node {
    ...
    public final static String versionId = "$Id: //core-platform/dev/src/com/redhat/persistence/pdl/nodes/FileNd.java#3 $ by $Author: jorris $, $DateTime: 2003/10/28 18:36:21 $";
