...
public class FileNd extends Node {
    ...
    public final static String versionId = "$Id: //core-platform/dev/src/com/redhat/persistence/pdl/nodes/FileNd.java#1 $ by $Author: rhs $, $DateTime: 2003/07/08 21:04:28 $";
