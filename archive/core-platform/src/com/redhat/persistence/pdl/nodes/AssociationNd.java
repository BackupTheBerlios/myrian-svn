...
public class AssociationNd extends StatementNd {
    ...
    public final static String versionId = "$Id: //core-platform/dev/src/com/redhat/persistence/pdl/nodes/AssociationNd.java#1 $ by $Author: rhs $, $DateTime: 2003/07/08 21:04:28 $";
