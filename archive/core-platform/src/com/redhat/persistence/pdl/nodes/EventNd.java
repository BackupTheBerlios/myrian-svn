...
public class EventNd extends Node {
    ...
    public final static String versionId = "$Id: //core-platform/dev/src/com/redhat/persistence/pdl/nodes/EventNd.java#4 $ by $Author: dennis $, $DateTime: 2004/03/30 17:47:27 $";
