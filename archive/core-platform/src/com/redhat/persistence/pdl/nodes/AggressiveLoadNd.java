...
public class AggressiveLoadNd extends StatementNd {
    ...
    public final static String versionId = "$Id: //core-platform/dev/src/com/redhat/persistence/pdl/nodes/AggressiveLoadNd.java#4 $ by $Author: dennis $, $DateTime: 2004/04/07 16:07:11 $";
