...
public class StringAd extends SimpleAdapter {
    ...
    public final static String versionId = "$Id: //core-platform/dev/src/com/redhat/persistence/pdl/adapters/StringAd.java#5 $ by $Author: dennis $, $DateTime: 2004/03/30 17:47:27 $";
