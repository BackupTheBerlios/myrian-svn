...
abstract class SimpleAdapter extends Adapter {
    ...
    public final static String versionId = "$Id: //core-platform/dev/src/com/redhat/persistence/pdl/adapters/SimpleAdapter.java#3 $ by $Author: justin $, $DateTime: 2003/10/23 15:28:18 $";
