...
public class FloatAd extends SimpleAdapter {
    ...
    public final static String versionId = "$Id: //core-platform/dev/src/com/redhat/persistence/pdl/adapters/FloatAd.java#4 $ by $Author: jorris $, $DateTime: 2003/10/28 18:36:21 $";
