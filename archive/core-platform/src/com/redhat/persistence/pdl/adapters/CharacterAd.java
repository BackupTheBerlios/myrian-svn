...
public class CharacterAd extends SimpleAdapter {
    ...
    public final static String versionId = "$Id: //core-platform/dev/src/com/redhat/persistence/pdl/adapters/CharacterAd.java#6 $ by $Author: dennis $, $DateTime: 2004/04/07 16:07:11 $";
