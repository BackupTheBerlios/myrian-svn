...
public abstract class PropertyEvent extends Event {
    ...
    public final static String versionId = "$Id: //core-platform/dev/src/com/redhat/persistence/PropertyEvent.java#4 $ by $Author: dennis $, $DateTime: 2004/03/30 17:47:27 $";
