...
public class JoinThrough extends Mapping {
    ...
    public final static String versionId = "$Id: //core-platform/dev/src/com/redhat/persistence/metadata/JoinThrough.java#5 $ by $Author: dennis $, $DateTime: 2004/04/07 16:07:11 $";
