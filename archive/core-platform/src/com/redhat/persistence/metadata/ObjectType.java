...
public class ObjectType extends Element {
    ...
    public final static String versionId = "$Id: //core-platform/dev/src/com/redhat/persistence/metadata/ObjectType.java#9 $ by $Author: dennis $, $DateTime: 2004/08/16 18:10:38 $";
