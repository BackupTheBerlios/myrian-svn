...
public class Link extends Property {
    ...
    public final static String versionId = "$Id: //core-platform/dev/src/com/redhat/persistence/metadata/Link.java#4 $ by $Author: dennis $, $DateTime: 2004/03/30 17:47:27 $";
