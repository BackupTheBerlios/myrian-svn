...
public class JoinTo extends Mapping {
    ...
    public final static String versionId = "$Id: //core-platform/dev/src/com/redhat/persistence/metadata/JoinTo.java#3 $ by $Author: jorris $, $DateTime: 2003/10/28 18:36:21 $";
