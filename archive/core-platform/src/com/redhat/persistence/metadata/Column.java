...
public class Column extends Element {
    ...
    public final static String versionId = "$Id: //core-platform/dev/src/com/redhat/persistence/metadata/Column.java#5 $ by $Author: dennis $, $DateTime: 2003/08/15 13:46:34 $";
