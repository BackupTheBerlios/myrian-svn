...
public class ObjectMap extends Element {
    ...
    public final static String versionId = "$Id: //core-platform/dev/src/com/redhat/persistence/metadata/ObjectMap.java#8 $ by $Author: dennis $, $DateTime: 2004/08/16 18:10:38 $";
