...
public class JoinFrom extends Mapping {
    ...
    public final static String versionId = "$Id: //core-platform/dev/src/com/redhat/persistence/metadata/JoinFrom.java#4 $ by $Author: dennis $, $DateTime: 2004/03/30 17:47:27 $";
