...
public class NotFetchedException extends CursorException {
    ...
    public final static String versionId = "$Id: //core-platform/dev/src/com/redhat/persistence/NotFetchedException.java#5 $ by $Author: dennis $, $DateTime: 2004/04/07 16:07:11 $";
