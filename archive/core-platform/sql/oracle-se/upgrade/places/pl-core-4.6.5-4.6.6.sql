...
--
-- $Id: //core-platform/dev/sql/oracle-se/upgrade/places/pl-core-4.6.5-4.6.6.sql#3 $
-- $DateTime: 2002/10/16 14:12:35 $


--
-- @author <a href="mailto:yon@arsdigita.com">yon@arsdigita.com</a>
-- @version $Id: //core-platform/dev/sql/oracle-se/upgrade/places/pl-core-4.6.5-4.6.6.sql#3 $ by $Author: dennis $, $DateTime: 2002/10/16 14:12:35 $
--
