...
--
-- $Id: //core-platform/dev/sql/oracle-se/categorization/categorization-drop.sql#3 $
...
-- @cvs-id $Id: //core-platform/dev/sql/oracle-se/categorization/categorization-drop.sql#3 $
--
