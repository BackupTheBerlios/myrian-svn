...
public class BooleanSwitch extends Switch {
    ...
    public final static String versionId = "$Id: //core-platform/test-packaging/src/com/arsdigita/util/cmd/BooleanSwitch.java#1 $ by $Author: dennis $, $DateTime: 2003/08/14 14:53:20 $";
