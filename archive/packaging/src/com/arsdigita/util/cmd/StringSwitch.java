...
public class StringSwitch extends Switch {
    ...
    public final static String versionId = "$Id: //core-platform/test-packaging/src/com/arsdigita/util/cmd/StringSwitch.java#3 $ by $Author: justin $, $DateTime: 2003/09/25 14:54:00 $";
