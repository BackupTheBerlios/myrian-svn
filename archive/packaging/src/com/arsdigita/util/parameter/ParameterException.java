 ...
 * @version $Id: //core-platform/test-packaging/src/com/arsdigita/util/parameter/ParameterException.java#2 $
 */
public final class ParameterException extends RuntimeException {
    public final static String versionId =
        "$Id: //core-platform/test-packaging/src/com/arsdigita/util/parameter/ParameterException.java#2 $" +
        "$Author: justin $" +
