 ...
 * @version $Id: //core-platform/test-packaging/src/com/arsdigita/util/parameter/ParameterError.java#1 $
 */
public final class ParameterError {
    public final static String versionId =
        "$Id: //core-platform/test-packaging/src/com/arsdigita/util/parameter/ParameterError.java#1 $" +
        "$Author: justin $" +
        "$DateTime: 2003/10/21 18:01:27 $";
