 ...
 *
 * @author David Eison
 * @version $Id: //core-platform/test-packaging/src/com/arsdigita/util/UncheckedWrapperException.java#1 $
 */
public class UncheckedWrapperException extends RuntimeException {

    public static final String versionId = "$Id: //core-platform/test-packaging/src/com/arsdigita/util/UncheckedWrapperException.java#1 $";
