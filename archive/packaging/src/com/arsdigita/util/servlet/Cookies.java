 ...
 * @version $Id: //core-platform/test-packaging/src/com/arsdigita/util/servlet/Cookies.java#1 $
 */
public class Cookies {
    public static final String versionId =
        "$Id: //core-platform/test-packaging/src/com/arsdigita/util/servlet/Cookies.java#1 $" +
        "$Author: justin $" +
        "$DateTime: 2003/10/19 13:00:08 $";
