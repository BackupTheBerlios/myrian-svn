 ...
 * @version $Id: //core-platform/test-packaging/src/com/arsdigita/util/servlet/HttpHost.java#1 $
 */
public class HttpHost {
    public static final String versionId =
        "$Id: //core-platform/test-packaging/src/com/arsdigita/util/servlet/HttpHost.java#1 $" +
        "$Author: justin $" +
