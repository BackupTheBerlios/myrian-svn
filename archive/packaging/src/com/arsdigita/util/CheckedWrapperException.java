 ...
 *
 * @author David Eison 
 * @version $Id: //core-platform/test-packaging/src/com/arsdigita/util/CheckedWrapperException.java#1 $
 */
public class CheckedWrapperException extends Exception {

    public static final String versionId = "$Id: //core-platform/test-packaging/src/com/arsdigita/util/CheckedWrapperException.java#1 $";
