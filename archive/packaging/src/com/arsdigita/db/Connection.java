...
public class Connection implements java.sql.Connection {
    ...
    public final static String versionId = "$Id: //core-platform/test-packaging/src/com/arsdigita/db/Connection.java#1 $ $Author: dennis $ $Date: 2003/08/14 $";
        ...
        if (s_cat.isDebugEnabled()) {
            ...
            synchronized (dbgConnections) {
                ...
                if (dbgConnections.size() >
                    ConnectionManager.getInstance().getConnectionPoolSize()) {
