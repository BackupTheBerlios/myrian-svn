 ...
 * @version $Id: //core-platform/test-packaging/src/com/arsdigita/db/postgres/PostgresConnectionPoolImpl.java#2 $ $DateTime: 2003/08/19 22:28:24 $
 * @since 4.5
 *
 */
...
public class PostgresConnectionPoolImpl extends BaseConnectionPool {
    ...
    public static final String versionId = "$Author: rhs $ - $Date: 2003/08/19 $ $Id: //core-platform/test-packaging/src/com/arsdigita/db/postgres/PostgresConnectionPoolImpl.java#2 $";
