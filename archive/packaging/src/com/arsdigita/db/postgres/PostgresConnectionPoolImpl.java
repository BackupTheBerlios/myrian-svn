 ...
 * @version $Id: //core-platform/test-packaging/src/com/arsdigita/db/postgres/PostgresConnectionPoolImpl.java#1 $ $DateTime: 2003/08/14 14:53:20 $
 * @since 4.5
 *
 */
...
public class PostgresConnectionPoolImpl extends BaseConnectionPool {
    ...
    public static final String versionId = "$Author: dennis $ - $Date: 2003/08/14 $ $Id: //core-platform/test-packaging/src/com/arsdigita/db/postgres/PostgresConnectionPoolImpl.java#1 $";
