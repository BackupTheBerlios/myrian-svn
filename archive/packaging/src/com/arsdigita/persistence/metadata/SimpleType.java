...
public class SimpleType extends DataType {
    ...
    public final static String versionId = "$Id: //core-platform/test-packaging/src/com/arsdigita/persistence/metadata/SimpleType.java#2 $ by $Author: rhs $, $DateTime: 2003/08/19 22:28:24 $";
