...
public class MetadataRoot extends Element {
    ...
    public final static String versionId = "$Id: //core-platform/test-packaging/src/com/arsdigita/persistence/metadata/MetadataRoot.java#1 $ by $Author: dennis $, $DateTime: 2003/08/14 14:53:20 $";
