 ...
 * @since 4.5
 * @version $Id: //core-platform/test-packaging/src/com/arsdigita/persistence/DataOperation.java#2 $
 */
public class DataOperation {

    public static final String versionId = "$Id: //core-platform/test-packaging/src/com/arsdigita/persistence/DataOperation.java#2 $ by $Author: rhs $, $DateTime: 2003/08/19 22:28:24 $";
