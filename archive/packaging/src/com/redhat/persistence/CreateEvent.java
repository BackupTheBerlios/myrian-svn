...
public class CreateEvent extends ObjectEvent {
    ...
    public final static String versionId = "$Id: //core-platform/test-packaging/src/com/redhat/persistence/CreateEvent.java#3 $ by $Author: justin $, $DateTime: 2003/10/23 11:58:56 $";
