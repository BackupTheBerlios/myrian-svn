...
public abstract class PropertyEvent extends Event {
    ...
    public final static String versionId = "$Id: //core-platform/test-packaging/src/com/redhat/persistence/PropertyEvent.java#2 $ by $Author: rhs $, $DateTime: 2003/08/19 22:28:24 $";
