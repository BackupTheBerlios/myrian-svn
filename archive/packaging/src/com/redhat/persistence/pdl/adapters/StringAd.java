...
public class StringAd extends SimpleAdapter {
    ...
    public final static String versionId = "$Id: //core-platform/test-packaging/src/com/redhat/persistence/pdl/adapters/StringAd.java#1 $ by $Author: dennis $, $DateTime: 2003/08/14 14:53:20 $";
