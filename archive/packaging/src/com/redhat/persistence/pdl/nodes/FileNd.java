...
public class FileNd extends Node {
    ...
    public final static String versionId = "$Id: //core-platform/test-packaging/src/com/redhat/persistence/pdl/nodes/FileNd.java#2 $ by $Author: rhs $, $DateTime: 2003/08/19 22:28:24 $";
