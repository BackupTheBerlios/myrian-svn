...
class Aggregator extends Event.Switch {
    ...
    public final static String versionId = "$Id: //core-platform/test-packaging/src/com/redhat/persistence/engine/rdbms/Aggregator.java#1 $ by $Author: dennis $, $DateTime: 2003/08/14 14:53:20 $";
