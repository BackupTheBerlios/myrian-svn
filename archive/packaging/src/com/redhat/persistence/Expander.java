...
class Expander extends Event.Switch {
    ...
    public final static String versionId = "$Id: //core-platform/test-packaging/src/com/redhat/persistence/Expander.java#3 $ by $Author: justin $, $DateTime: 2003/10/01 11:07:58 $";
