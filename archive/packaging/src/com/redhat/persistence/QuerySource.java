...
public abstract class QuerySource {
    ...
    public final static String versionId = "$Id: //core-platform/test-packaging/src/com/redhat/persistence/QuerySource.java#3 $ by $Author: rhs $, $DateTime: 2003/08/27 19:33:58 $";
