...
public class SQLToken {
    ...
    public final static String versionId = "$Id: //core-platform/test-packaging/src/com/redhat/persistence/common/SQLToken.java#3 $ by $Author: rhs $, $DateTime: 2003/10/01 14:17:42 $";
