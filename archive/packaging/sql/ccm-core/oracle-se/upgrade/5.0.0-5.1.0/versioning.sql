...
--
-- $Id: //core-platform/test-packaging/sql/ccm-core/oracle-se/upgrade/5.0.0-5.1.0/versioning.sql#1 $
...
create or replace function last_attr_value(attr varchar2, start_transaction_id in integer)
return varchar2
is
  v_master_id integer;
  start_time date;
