...
--
-- $Id: //core-platform/test-packaging/sql/ccm-core/oracle-se/kernel/drop-all.sql#1 $
...
-- @cvs-id $Id: //core-platform/test-packaging/sql/ccm-core/oracle-se/kernel/drop-all.sql#1 $
