...
public class URLRewriterTest extends TestCase {
    ...
    public static final String versionId = "$Id: //core-platform/test-packaging/test/src/com/arsdigita/util/URLRewriterTest.java#2 $ by $Author: rhs $, $DateTime: 2003/08/19 22:28:24 $";
