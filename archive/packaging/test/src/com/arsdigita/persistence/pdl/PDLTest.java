...
public class PDLTest extends TestCase {
    ...
    public final static String versionId = "$Id: //core-platform/test-packaging/test/src/com/arsdigita/persistence/pdl/PDLTest.java#1 $ by $Author: dennis $, $DateTime: 2003/08/14 14:53:20 $";
