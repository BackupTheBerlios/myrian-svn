...
public class DataSuite extends PackageTestSuite {
    ...
    public final static String versionId = "$Id: //core-platform/test-packaging/test/src/com/arsdigita/persistence/tests/data/DataSuite.java#2 $ by $Author: rhs $, $DateTime: 2003/08/19 22:28:24 $";
