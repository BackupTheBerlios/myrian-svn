...
public class CRUDTestlet extends Testlet {
    ...
    public final static String versionId = "$Id: //core-platform/test-packaging/test/src/com/arsdigita/persistence/tests/data/CRUDTestlet.java#2 $ by $Author: rhs $, $DateTime: 2003/08/19 22:28:24 $";
