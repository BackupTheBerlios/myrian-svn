...
public class MappingsTest extends BaseTestCase {
    ...
    public final static String versionId = "$Id: //core-platform/test-packaging/test/src/com/arsdigita/persistence/tests/data/MappingsTest.java#1 $ by $Author: dennis $, $DateTime: 2003/08/14 14:53:20 $";
