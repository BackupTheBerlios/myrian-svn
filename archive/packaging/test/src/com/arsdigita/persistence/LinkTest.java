 ...
 * @version $Revision: #3 $ $Date: 2003/09/09 $
 **/

public abstract class LinkTest extends PersistenceTestCase {

    public final static String versionId = "$Id: //core-platform/test-packaging/test/src/com/arsdigita/persistence/LinkTest.java#3 $ by $Author: rhs $, $DateTime: 2003/09/09 17:32:16 $";
