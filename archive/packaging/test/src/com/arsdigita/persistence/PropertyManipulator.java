...
public class PropertyManipulator {
    ...
    public final static String versionId = "$Id: //core-platform/test-packaging/test/src/com/arsdigita/persistence/PropertyManipulator.java#2 $ by $Author: rhs $, $DateTime: 2003/08/19 22:28:24 $";
