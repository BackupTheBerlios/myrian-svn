...
public class KeyGenerator {
    ...
    public static final String versionId = "$Id: //core-platform/test-packaging/test/src/com/arsdigita/persistence/KeyGenerator.java#1 $ by $Author: dennis $, $DateTime: 2003/08/14 14:53:20 $";
