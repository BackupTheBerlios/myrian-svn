...
public class ObjectTypeValidator  {
    ...
    public final static String versionId = "$Id: //core-platform/test-packaging/test/src/com/arsdigita/persistence/ObjectTypeValidator.java#3 $ by $Author: jorris $, $DateTime: 2003/10/01 17:13:24 $";
