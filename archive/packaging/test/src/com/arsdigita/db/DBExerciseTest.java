...
public class DBExerciseTest extends TestCase {
    ...
    public static final String versionId = "$Id: //core-platform/test-packaging/test/src/com/arsdigita/db/DBExerciseTest.java#2 $ by $Author: rhs $, $DateTime: 2003/08/19 22:28:24 $";
